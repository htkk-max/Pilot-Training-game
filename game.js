var _STRINGS = {
    ...
    Game: {
        ...
        Score: "Score",
        Time: "Time",
        pilotLevel: ["pilot level", 51, 195, 0.95, 0.98],
        ...
        fail: ["Mission Failed", 320, 399, 1, 1.1],
        ...
        ship2: ["Survive for 60 seconds.", 48, 180, 0.7, 0.8],
...
(function(b, c) {
    function d(b, f, q) {
        if (q === c && 1 === b.nodeType)
            if (
                ((q = "data-" + f.replace(sc, "-$1").toLowerCase()),
                    (q = b.getAttribute(q)),
                    "string" == typeof q)
            ) {
                try {
    ...
    function l(b, f) {
        ...
        1 === f.nodeType &&
            (f.clearAttributes && f.clearAttributes(),
                ...
                "object" === q ?
                (f.parentNode && (f.outerHTML = b.outerHTML),
                    e.support.html5Clone &&
                    b.innerHTML &&
                    !e.trim(f.innerHTML) &&
                    (f.innerHTML = b.innerHTML)) :
                "input" === q && xb.test(b.type) ?
                ((f.defaultChecked = f.checked = b.checked),
                    f.value !== b.value && (f.value = b.value)) :
                "option" === q ?
                (f.selected = b.defaultSelected) :
                "input" === q || "textarea" === q ?
                (f.defaultValue = b.defaultValue) :
                "script" === q && f.text !== b.text && (f.text = b.text),
                f.removeAttribute(e.expando));
    }
    ...
    function x(b, f) {
        if (f in b) return f;
        for (
            var q = f.charAt(0).toUpperCase() + f.slice(1), c = f, e = yb.length; e--;
    ...
    function H(b, f) {
        for (var q, c, d = [], s = 0, m = b.length; s < m; s++)
            (q = b[s]),
            q.style &&
            ((d[s] = e._data(q, "olddisplay")),
                f ?
                (!d[s] && "none" === q.style.display && (q.style.display = ""),
                    "" === q.style.display &&
                    L(q) &&
                    (d[s] = e._data(q, "olddisplay", K(q.nodeName)))) :
                ((c = R(q, "display")),
                    !d[s] && "none" !== c && e._data(q, "olddisplay", c)));
        for (s = 0; s < m; s++)
            if (
                ((q = b[s]),
                    q.style && (!f || "none" === q.style.display || "" === q.style.display))
            )
                q.style.display = f ? d[s] || "" : "none";
        return b;
    }
    ...
    function N(b, f, q, c) {
        ...
        for (var d = 0; 4 > f; f += 2)
            "margin" === q && (d += e.css(b, q + fa[f], !0)),
            c ?
            ("content" === q && (d -= parseFloat(R(b, "padding" + fa[f])) || 0),
                "margin" !== q &&
                (d -= parseFloat(R(b, "border" + fa[f] + "Width")) || 0)) :
            ((d += parseFloat(R(b, "padding" + fa[f])) || 0),
                "padding" !== q &&
                (d += parseFloat(R(b, "border" + fa[f] + "Width")) || 0));
        return d;
    }
    ...
    function K(b) {
        ...
        f.remove();
        if ("none" === c || "" === c) {
            ma = D.body.appendChild(
                ma ||
                e.extend(D.createElement("iframe"), {
                    frameBorder: 0,
                    width: 0,
                    height: 0,
                })
    ...
    function O(b, f, c, C) {
        var d;
        if (e.isArray(f))
            e.each(f, function(f, e) {
                c || wc.test(b) ?
                    C(b, e) :
                    O(b + "[" + ("object" == typeof e ? f : "") + "]", e, c, C);
            });
        else if (!c && "object" === e.type(f))
    ...
    function oa(b, f, q, e, d, s) {
        ...
        var m;
        d = b[d];
        for (var l = 0, g = d ? d.length : 0, j = b === Za; l < g && (j || !m); l++)
            (m = d[l](f, q, e)),
            "string" == typeof m &&
            (!j || s[m] ?
                (m = c) :
                (f.dataTypes.unshift(m), (m = oa(b, f, q, e, m, s))));
    ...
    function Bb(b, f, c) {
        var C,
            ...
            l = function() {
                for (
                    var f = Ba || Ab(),
                        f = Math.max(0, g.startTime + g.duration - f),
                        c = 1 - (f / g.duration || 0),
                        q = 0,
                        e = g.tweens.length; q < e; q++
                )
                    g.tweens[q].run(c);
                return (
                    m.notifyWith(b, [g, c, f]),
                    1 > c && e ? f : (m.resolveWith(b, [g]), !1)
                );
            },
            g = m.promise({
                elem: b,
                ...
                createTween: function(f, c) {
                    var q = e.Tween(
                        ...
                        f,
                        c,
                        g.opts.specialEasing[f] || g.opts.easing
                    );
                    return g.tweens.push(q), q;
                },
                stop: function(f) {
                    for (var c = 0, q = f ? g.tweens.length : 0; c < q; c++)
                        g.tweens[c].run(1);
        ...
        for (C in f)
            if (
                ((j = e.camelCase(C)),
                    (p = c[j]),
                    (t = f[C]),
                    e.isArray(t) && ((p = t[1]), (t = f[C] = t[0])),
                    C !== j && ((f[j] = t), delete f[C]),
                    (r = e.cssHooks[j]) && "expand" in r)
            )
                for (C in ((t = r.expand(t)), delete f[j], t))
                    C in f || ((f[C] = t[C]), (c[C] = p));
            else c[j] = p;
        for (; d < s; d++)
        ...
        e.each(f, function(b, u) {
            for (
                var f = (ua[b] || []).concat(ua["*"]), c = 0, q = f.length; c < q && !f[c].call(n, b, u); c++
            );
        });
        return (
            e.isFunction(g.opts.start) && g.opts.start.call(b, g),
            e.fx.timer(
                e.extend(l, {
                    anim: g,
                    queue: g.opts.queue,
    ...
    function Da(b, f) {
        var c,
            ...
            d = 0;
        for (f = f ? 1 : 0; 4 > d; d += 2 - f)
            (c = fa[d]), (e["margin" + c] = e["padding" + c] = b);
    ...
    var Db,
        ...
        Ga = function() {
            D.addEventListener ?
                (D.removeEventListener("DOMContentLoaded", Ga, !1), e.ready()) :
                "complete" === D.readyState &&
                (D.detachEvent("onreadystatechange", Ga), e.ready());
        },
        Hb = {};
    e.fn = e.prototype = {
        constructor: e,
        init: function(b, f, q) {
            ...
            if ("string" == typeof b) {
                ...
                if (C && (C[1] || !f)) {
                    if (C[1])
                        return (
                            (f = f instanceof e ? f[0] : f),
                            (d = f && f.nodeType ? f.ownerDocument || f : D),
                            (b = e.parseHTML(C[1], d, !0)),
                            Gb.test(C[1]) && e.isPlainObject(f) && this.attr.call(b, f, !0),
                            e.merge(this, b)
                        );
        ...
        pushStack: function(b, f, c) {
            ...
            return (
                ...
                f && (b.selector = this.selector + "." + f + "(" + c + ")"),
                b
            );
        },
        each: function(b, f) {
        ...
        for (g === l && ((m = this), --l); l < g; l++)
            if (null != (b = arguments[l]))
                for (f in b)
                    ...
                    (C = b[f]),
                    m !== C &&
                    (j && C && (e.isPlainObject(C) || (d = e.isArray(C))) ?
                        (d ?
                            ((d = !1), (s = q && e.isArray(q) ? q : [])) :
                            (s = q && e.isPlainObject(q) ? q : {}),
                            (m[f] = e.extend(j, s, C))) :
                        C !== c && (m[f] = C));
        return m;
    };
    e.extend({
        ...
        ready: function(b) {
            if (!(!0 === b ? --e.readyWait : e.isReady)) {
                ...
                (!0 !== b && 0 < --e.readyWait) ||
                (Ea.resolveWith(D, [e]),
                    e.fn.trigger && e(D).trigger("ready").off("ready"));
            }
        },
        ...
        isPlainObject: function(b) {
            ...
            try {
                if (
                    b.constructor &&
                    !$a.call(b, "constructor") &&
                    !$a.call(b.constructor.prototype, "isPrototypeOf")
                )
                    return !1;
            } catch (f) {
                return !1;
        ...
        parseHTML: function(b, f, c) {
            ...
            return !b || "string" != typeof b ?
                null :
                ("boolean" == typeof f && ((c = f), (f = 0)),
                    (f = f || D),
                    (d = Gb.exec(b)) ? [f.createElement(d[1])] :
                    ((d = e.buildFragment([b], f, c ? null : [])),
                        e.merge(
                            [],
                            (d.cacheable ? e.clone(d.fragment) : d.fragment).childNodes
                        )));
        },
        parseJSON: function(u) {
            ...
            if (Gc.test(u.replace(Ic, "@").replace(Jc, "]").replace(Hc, "")))
        ...
        parseXML: function(u) {
            ...
            try {
                b.DOMParser ?
                    ((q = new DOMParser()), (f = q.parseFromString(u, "text/xml"))) :
        ...
        proxy: function(b, f) {
            var q, d, v;
            return (
                "string" == typeof f && ((q = b[f]), (f = b), (b = q)),
                e.isFunction(b) ?
                ((d = aa.call(arguments, 2)),
                    (v = function() {
                        return b.apply(f, d.concat(aa.call(arguments)));
                    }),
                    (v.guid = b.guid = b.guid || e.guid++),
                    v) :
                c
            );
        },
    ...
    e.ready.promise = function(u) {
        if (!Ea)
            if (((Ea = e.Deferred()), "complete" === D.readyState))
    ...
    e.Callbacks = function(b) {
        ...
        if ("string" == typeof b) {
            if (!(f = Ib[b])) {
                ...
                var q = (Ib[f] = {});
                f =
                    (e.each(f.split(ga), function(b, u) {
                            q[u] = !0;
                        }),
                        q);
            }
                    ...
                    if (j) {
                        ...
                        (function xc(f) {
                            e.each(f, function(f, c) {
                                var q = e.type(c);
                                "function" === q && (!b.unique || !r.has(c)) ?
                                    j.push(c) :
                                    c && c.length && "string" !== q && xc(c);
                            });
                        })(arguments);
                ...
                remove: function() {
                    return (
                        ...
                        e.each(arguments, function(b, u) {
                            for (var f; - 1 < (f = e.inArray(u, j, f));)
                                j.splice(f, 1), s && (f <= l && l--, f <= g && g--);
                        }),
                        this
                    );
                },
    ...
    if (!Ha || !Ha.length) bb = {};
        ...
        if (M.attachEvent)
            for (cb in {
                ...
                (Ka = "on" + cb),
                (va = Ka in M) ||
                (M.setAttribute(Ka, "return;"), (va = "function" == typeof M[Ka])),
                (Q[cb + "Bubbles"] = va);
        bb =
            (e(function() {
                    var u,
                    ...
                    d &&
                        ((u = D.createElement("div")),
                            ...
                            (Q.reliableHiddenOffsets = va && 0 === c[0].offsetHeight),
                            (f.innerHTML = ""),
                            (f.style.cssText =
                                "box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;padding:1px;border:1px;display:block;width:4px;margin-top:1%;position:absolute;top:1%;"),
                            (Q.boxSizing = 4 === f.offsetWidth),
                            (Q.doesNotIncludeMarginInBodyOffset = 1 !== d.offsetTop),
                            b.getComputedStyle &&
                            ((Q.pixelPosition =
                                    "1%" !== (b.getComputedStyle(f, null) || {}).top),
                                (Q.boxSizingReliable =
                                    "4px" ===
                                    (
                                        b.getComputedStyle(f, null) || {
                                            width: "4px",
                                        }
                                    ).width),
                                ...
                                (f.style.width = "1px"),
                                f.appendChild(e),
                                (Q.reliableMarginRight = !parseFloat(
                                    (b.getComputedStyle(e, null) || {}).marginRight
                                ))),
                            "undefined" != typeof f.style.zoom &&
                            ((f.innerHTML = ""),
                                (f.style.cssText =
                                    "padding:0;margin:0;border:0;display:block;overflow:hidden;width:1px;padding:1px;display:inline;zoom:1"),
                                (Q.inlineBlockNeedsLayout = 3 === f.offsetWidth),
                                (f.style.display = "block"),
                                (f.style.overflow = "visible"),
                                (f.innerHTML = "<div></div>"),
                                (f.firstChild.style.width = "5px"),
                                (Q.shrinkWrapBlocks = 3 !== f.offsetWidth),
                                (u.style.zoom = 1)),
                            d.removeChild(u));
                }),
                ia.removeChild(M),
                (Ha = ha = Ia = Ja = U = ia = M = null),
                Q);
    }
    Nc.support = bb;
    var tc = /(?:\{[\s\S]*\}|\[[\s\S]*\])$/,
    ...
    e.extend({
        ...
        hasData: function(b) {
            return (
                (b = b.nodeType ? e.cache[b[e.expando]] : b[e.expando]), !!b && !g(b)
            );
        },
        data: function(b, f, q, d) {
            if (e.acceptData(b)) {
                ...
                if ((p && j[p] && (d || j[p].data)) || !(l && q === c)) {
                    ...
                    j[p] || ((j[p] = {}), g || (j[p].toJSON = e.noop));
                    if ("object" == typeof f || "function" == typeof f)
                        d ?
                        (j[p] = e.extend(j[p], f)) :
                        (j[p].data = e.extend(j[p].data, f));
                    return (
                        (v = j[p]),
                        d || (v.data || (v.data = {}), (v = v.data)),
                        q !== c && (v[e.camelCase(f)] = q),
                        l ? ((s = v[f]), null == s && (s = v[e.camelCase(f)])) : (s = v),
                        s
                    );
                }
            }
                    ...
                    if (f && (d = c ? l[j] : l[j].data)) {
                        e.isArray(f) ||
                            (f in d ?
                                (f = [f]) :
                                ((f = e.camelCase(f)),
                                    f in d ? (f = [f]) : (f = f.split(" "))));
                        v = 0;
                        for (s = f.length; v < s; v++) delete d[f[v]];
                        if (!(c ? g : e.isEmptyObject)(d)) return;
                    }
                    if (c || !(delete l[j].data, !g(l[j])))
                        m ?
                        e.cleanData([b], !0) :
                        e.support.deleteExpando || l != l.window ?
                        delete l[j] :
                        (l[j] = null);
                }
            }
    ...
    e.fn.extend({
        data: function(b, f) {
            ...
            if (b === c) {
                if (
                    this.length &&
                    ((j = e.data(l)), 1 === l.nodeType && !e._data(l, "parsedAttrs"))
                ) {
                    v = l.attributes;
                    for (m = v.length; g < m; g++)
                        (s = v[g].name),
                        s.indexOf("data-") ||
                        ((s = e.camelCase(s.substring(5))), d(l, s, j[s]));
                ...
                ((q = b.split(".", 2)),
                    ...
                    e.access(
                        ...
                        function(f) {
                            if (f === c)
                                return (
                                    (j = this.triggerHandler("getData" + C, [q[0]])),
                                    j === c && l && ((j = e.data(l, b)), (j = d(l, b, j))),
                                    j === c && q[1] ? this.data(q[0]) : j
                                );
                            q[1] = f;
                            this.each(function() {
                                var c = e(this);
                                ...
                                e.data(this, b, f);
                                c.triggerHandler("changeData" + C, q);
                            });
                        },
                        null,
                        f,
    ...
    e.extend({
        ...
        dequeue: function(b, f) {
            ...
            v &&
                ("fx" === f && c.unshift("inprogress"), delete s.stop, v.call(b, m, s));
            !d && s && s.empty.fire();
        },
    ...
    e.fn.extend({
        ...
        toggleClass: function(b, f) {
            ...
            return e.isFunction(b) ?
                this.each(function(c) {
                    e(this).toggleClass(b.call(this, c, this.className, f), f);
                }) :
                this.each(function() {
                    if ("string" === c)
                        for (
                            var v, s = 0, m = e(this), l = f, g = b.split(ga);
                            (v = g[s++]);
        ...
        hasClass: function(b) {
            ...
            for (var f = 0, c = this.length; f < c; f++)
                if (
                    1 === this[f].nodeType &&
                    0 <= (" " + this[f].className + " ").replace(Mb, " ").indexOf(b)
                )
                    return !0;
            return !1;
        },
        val: function(b) {
            ...
            if (arguments.length)
                return (
                    ...
                    this.each(function(q) {
                        ...
                        if (
                            1 === this.nodeType &&
                            (d ? (m = b.call(this, q, v.val())) : (m = b),
                                null == m ?
                                (m = "") :
                                "number" == typeof m ?
                                (m += "") :
                                e.isArray(m) &&
                                (m = e.map(m, function(b) {
                                    return null == b ? "" : b + "";
                                })),
                                (f =
                                    e.valHooks[this.type] ||
                                    e.valHooks[this.nodeName.toLowerCase()]),
                                !f || !("set" in f) || f.set(this, m, "value") === c)
                        )
                            this.value = m;
                    })
                );
            if (v)
                return (
                    (f = e.valHooks[v.type] || e.valHooks[v.nodeName.toLowerCase()]),
                    f && "get" in f && (q = f.get(v, "value")) !== c ?
                    q :
                    ((q = v.value),
                        "string" == typeof q ? q.replace(Oc, "") : null == q ? "" : q)
                );
        },
    });
    e.extend({
                        ...
                        if (
                            ((f = s[b]),
                                ...
                                (!f.parentNode.disabled ||
                                    !e.nodeName(f.parentNode, "optgroup")))
                        ) {
                            f = e(f).val();
                            if (m) return f;
                            v.push(f);
        ...
        attr: function(b, f, q, d) {
            ...
            if (b && !(3 === m || 8 === m || 2 === m)) {
                ...
                (d = 1 !== m || !e.isXMLDoc(b)) &&
                ((f = f.toLowerCase()),
                    (s = e.attrHooks[f] || (Nb.test(f) ? Kb : ca)));
                if (q !== c) {
                    if (null === q) {
                        e.removeAttr(b, f);
                        return;
                    }
                    return s && "set" in s && d && (v = s.set(b, q, f)) !== c ?
                        v :
                        (b.setAttribute(f, q + ""), q);
                }
                return s && "get" in s && d && null !== (v = s.get(b, f)) ?
                    v :
                    ((v = b.getAttribute(f)), null === v ? c : v);
            }
        },
        removeAttr: function(b, f) {
            var c,
                ...
                m = 0;
            if (f && 1 === b.nodeType)
                for (d = f.split(ga); m < d.length; m++)
                    (v = d[m]) &&
                    ((c = e.propFix[v] || v),
                        (s = Nb.test(v)),
                        s || e.attr(b, v, ""),
                        b.removeAttribute(Ob ? v : c),
                        s && c in b && (b[c] = !1));
        },
        attrHooks: {
            type: {
        ...
        prop: function(b, f, q) {
            ...
            if (b && !(3 === m || 8 === m || 2 === m))
                return (
                    (s = 1 !== m || !e.isXMLDoc(b)),
                    s && ((f = e.propFix[f] || f), (v = e.propHooks[f])),
                    q !== c ?
                    v && "set" in v && (d = v.set(b, q, f)) !== c ?
                    d :
                    (b[f] = q) :
                    v && "get" in v && null !== (d = v.get(b, f)) ?
                    d :
                    b[f]
                );
        },
    ...
    Kb = {
        ...
        set: function(b, f, c) {
            ...
            return (
                ...
                ((d = e.propFix[c] || c),
                    d in b && (b[d] = !0),
                    b.setAttribute(c, c.toLowerCase())),
                c
            );
        },
    };
        ...
        ((Lb = {
            ...
            (ca = e.valHooks.button = {
                get: function(b, f) {
                    var e;
                    return (
                        (e = b.getAttributeNode(f)),
                        e && (Lb[f] ? "" !== e.value : e.specified) ? e.value : c
                    );
                },
                set: function(b, f, c) {
                    var e = b.getAttributeNode(c);
                    return (
                        e || ((e = D.createAttribute(c)), b.setAttributeNode(e)),
                        (e.value = f + "")
                    );
                },
            }),
    ...
    e.support.hrefNormalized ||
        e.each(["href", "src", "width", "height"], function(b, f) {
            e.attrHooks[f] = e.extend(e.attrHooks[f], {
                get: function(b) {
    ...
    e.event = {
        add: function(b, f, d, C, v) {
            ...
            if (
                !(3 === b.nodeType || 8 === b.nodeType || !f || !d || !(s = e._data(b)))
            ) {
                ...
                ((s.handle = m =
                        function(b) {
                            return "undefined" != typeof e &&
                                (!b || e.event.triggered !== b.type) ?
                                e.event.dispatch.apply(m.elem, arguments) :
                                c;
                        }),
                    (m.elem = b));
                f = e.trim(Rb(f)).split(" ");
                for (s = 0; s < f.length; s++) {
                    ...
                    if (
                        ...
                        ((r = l[j] = []),
                            (r.delegateCount = 0),
                            !n.setup || !1 === n.setup.call(b, C, p, m))
                    )
                        b.addEventListener ?
                        b.addEventListener(j, m, !1) :
                        b.attachEvent && b.attachEvent("on" + j, m);
                    n.add &&
                        (n.add.call(b, g), g.handler.guid || (g.handler.guid = d.guid));
                ...
                for (s = 0; s < f.length; s++)
                    if (((m = Pb.exec(f[s]) || []), (l = g = m[1]), (m = m[2]), l)) {
                        ...
                        for (p = 0; p < n.length; p++)
                            ...
                            (v || g === z.origType) &&
                            (!c || c.guid === z.guid) &&
                            (!m || m.test(z.namespace)) &&
                            (!d || d === z.selector || ("**" === d && z.selector)) &&
                            (n.splice(p--, 1),
                                z.selector && n.delegateCount--,
                                r.remove && r.remove.call(b, z));
                        0 === n.length &&
                            j !== n.length &&
                            ((!r.teardown || !1 === r.teardown.call(b, m, x.handle)) &&
                                e.removeEvent(b, l, x.handle),
                                delete t[l]);
                    } else
        ...
        trigger: function(u, f, d, C) {
            if (!d || (3 !== d.nodeType && 8 !== d.nodeType)) {
                ...
                g = [];
                if (
                    !Qb.test(r + e.event.triggered) &&
                    (0 <= r.indexOf("!") && ((r = r.slice(0, -1)), (v = !0)),
                        0 <= r.indexOf(".") &&
                        ((g = r.split(".")), (r = g.shift()), g.sort()),
                        (d && !e.event.customEvent[r]) || e.event.global[r])
                )
                    if (
                        ((u =
                                "object" == typeof u ?
                        ...
                        if (
                            ((u.result = c),
                                u.target || (u.target = d),
                                (f = null != f ? e.makeArray(f) : []),
                                f.unshift(u),
                                (j = e.event.special[r] || {}),
                                !(j.trigger && !1 === j.trigger.apply(d, f)))
                        ) {
                            t = [
                                [d, j.bindType || r]
                            ];
                            if (!C && !j.noBubble && !e.isWindow(d)) {
                                ...
                                for (m = d; v; v = v.parentNode) t.push([v, l]), (m = v);
                                m === (d.ownerDocument || D) &&
                                    t.push([m.defaultView || m.parentWindow || b, l]);
                            }
                            for (l = 0; l < t.length && !u.isPropagationStopped(); l++)
                                (v = t[l][0]),
                                (u.type = t[l][1]),
                                (p =
                                    (e._data(v, "events") || {})[u.type] &&
                                    e._data(v, "handle")) && p.apply(v, f),
                                (p = g && v[g]) &&
                                e.acceptData(v) &&
                                p.apply &&
                                !1 === p.apply(v, f) &&
                            ...
                            return (
                                ...
                                (!j._default ||
                                    !1 === j._default.apply(d.ownerDocument, f)) &&
                                ("click" !== r || !e.nodeName(d, "a")) &&
                                e.acceptData(d) &&
                                g &&
                                d[r] &&
                                (("focus" !== r && "blur" !== r) ||
                        ...
                        for (l in ((d = e.cache), d))
                            d[l].events &&
                            d[l].events[r] &&
                            e.event.trigger(u, f, d[l].handle.elem, !0);
            }
        },
        dispatch: function(u) {
            ...
            if (!(t.preDispatch && !1 === t.preDispatch.call(this, u))) {
                ...
                for (f = 0; f < n.length && !u.isPropagationStopped(); f++) {
                    ...
                    for (
                        d = 0; d < l.matches.length && !u.isImmediatePropagationStopped(); d++
                    )
                        if (
                            ((C = l.matches[d]),
                                r ||
                                (!u.namespace && !C.namespace) ||
                                (u.namespace_re && u.namespace_re.test(C.namespace)))
                        )
                            (u.data = C.data),
                            (u.handleObj = C),
                            (C = (
                                (e.event.special[C.origType] || {}).handle || C.handler
                            ).apply(l.elem, p)),
                            C !== c &&
                            ((u.result = C),
            ...
            filter: function(b, f) {
                ...
                return (
                    ...
                    ((d = b.target.ownerDocument || D),
                        ...
                        (b.pageX =
                            f.clientX +
                            ((e && e.scrollLeft) || (l && l.scrollLeft) || 0) -
                            ((e && e.clientLeft) || (l && l.clientLeft) || 0)),
                        (b.pageY =
                            f.clientY +
                            ((e && e.scrollTop) || (l && l.scrollTop) || 0) -
                            ((e && e.clientTop) || (l && l.clientTop) || 0))),
                    !b.relatedTarget &&
                    m &&
                    (b.relatedTarget = m === b.target ? f.toElement : m),
                    !b.which &&
                    s !== c &&
                    (b.which = s & 1 ? 1 : s & 2 ? 3 : s & 4 ? 2 : 0),
                    b
                );
            },
        },
        fix: function(b) {
            ...
            return (
                b.target || (b.target = d.srcElement || D),
    ...
    e.removeEvent = D.removeEventListener ?
        function(b, f, c) {
        ...
        function(b, f, c) {
            f = "on" + f;
            b.detachEvent &&
                ("undefined" == typeof b[f] && (b[f] = null), b.detachEvent(f, c));
        };
        ...
        (e.event.special.submit = {
            setup: function() {
                ...
                e.event.add(this, "click._submit keypress._submit", function(b) {
                    b = b.target;
                    (b =
                        e.nodeName(b, "input") || e.nodeName(b, "button") ? b.form : c) &&
                    !e._data(b, "_submit_attached") &&
                        (e.event.add(b, "submit._submit", function(b) {
                                b._submit_bubble = !0;
                            }),
            ...
            postDispatch: function(b) {
                b._submit_bubble &&
                    (delete b._submit_bubble,
                        this.parentNode &&
                        !b.isTrigger &&
                        e.event.simulate("submit", this.parentNode, b, !0));
            },
            teardown: function() {
                if (e.nodeName(this, "form")) return !1;
        ...
        (e.event.special.change = {
            setup: function() {
                ...
                e.event.add(this, "beforeactivate._change", function(b) {
                    b = b.target;
                    db.test(b.nodeName) &&
                        !e._data(b, "_change_attached") &&
                        (e.event.add(b, "change._change", function(b) {
                                this.parentNode &&
                                    !b.isSimulated &&
                                    !b.isTrigger &&
        ...
        on: function(b, f, d, l, v) {
            ...
            return (
                ...
                ((s = l),
                    ...
                    (l.guid = s.guid || (s.guid = e.guid++))),
                this.each(function() {
                    e.event.add(this, b, l, d, f);
                })
            );
        },
        ...
        toggle: function(b) {
            var f = arguments,
                ...
                l = function(c) {
                    ...
                    return (
                        e._data(this, "lastToggle" + b.guid, q + 1),
                        c.preventDefault(),
                        f[q].apply(this, arguments) || !1
                    );
                };
    ...
    e.each(
        ...
        function(b, f) {
            e.fn[f] = function(b, c) {
                return (
                    null == c && ((c = b), (b = null)),
                    0 < arguments.length ? this.on(f, null, b, c) : this.trigger(f)
                );
            };
    ...
    var Vc = b,
            ...
            if (!m && !d && (e = Wc.exec(b)))
                if ((g = e[1]))
                    if (9 === j) {
                        ...
                        if (
                            f.ownerDocument &&
                            (l = f.ownerDocument.getElementById(g)) &&
                            Sb(f, l) &&
                            l.id === g
                        )
                            return c.push(l), c;
                ...
                if (e[2])
                    return pa.apply(c, qa.call(f.getElementsByTagName(b), 0)), c;
                if ((g = e[3]) && Tb && f.getElementsByClassName)
                    return pa.apply(c, qa.call(f.getElementsByClassName(g), 0)), c;
            }
        ...
        ja = function(b) {
            return Y(function(f) {
                return (
                    (f = +f),
                    Y(function(c, d) {
                        for (var e, l = b([], c.length, f), m = l.length; m--;)
                            c[(e = l[m])] && (c[e] = !(d[e] = c[e]));
                    })
                );
            });
        ...
        Pa = function(b, f) {
            ...
            for (j = G.preFilter; m;) {
                if (!c || (d = Xc.exec(m)))
                    d && (m = m.slice(d[0].length)), g.push((e = []));
                c = !1;
                if ((d = Yc.exec(m)))
                    e.push((c = new Wb(d.shift()))),
                    (m = m.slice(c.length)),
                    (c.type = d[0].replace(Ma, " "));
                for (l in G.filter)
                    (d = Oa[l].exec(m)) &&
                    (!j[l] || (d = j[l](d, X, !0))) &&
                    (e.push((c = new Wb(d.shift()))),
            ...
            return f.first ?
                ...
                function(f, c, q) {
                    if (q)
                        ...
                        for (var g, j = xa + " " + l + " ", p = j + fb;
                            (f = f[d]);)
                            if (e || 1 === f.nodeType) {
                                if ((g = f[P]) === p) return f.sizset;
                                if ("string" == typeof g && 0 === g.indexOf(j)) {
                ...
                Y(function(l, g, s, j) {
                    if (!l || !e) {
                        ...
                        if (l)
                            ...
                            (A = Qa(A === g ? A.splice(z, A.length) : A)),
                            e ? e(null, g, A, j) : pa.apply(g, A);
                    }
                })
            );
        },
            ...
            if (!d && 1 === p.length) {
                ...
                for (l = Oa.POS.test(b) ? -1 : m.length - 1; 0 <= l; l--) {
                    ...
                    if ((j = G.find[j]))
                        if (
                            (d = j(
                                g.matches[0].replace(ka, ""),
                                (kb.test(m[0].type) && f.parentNode) || f,
                                e
                            ))
                        ) {
                            m.splice(l, 1);
    ...
    Sa = I.getText = function(b) {
        ...
        if ((f = b.nodeType))
            if (1 === f || 9 === f || 11 === f) {
                ...
                for (b = b.firstChild; b; b = b.nextSibling) c += Sa(b);
            } else {
    ...
    Sb = I.contains = W.contains ?
        function(b, f) {
            var c = 9 === b.nodeType ? b.documentElement : b,
                d = f && f.parentNode;
            return (
                b === d || !(!d || !(1 === d.nodeType && c.contains && c.contains(d)))
            );
        } :
    ...
    G = I.selectors = {
        ...
        find: {
            ID: mb ?
                function(b, f, c) {
                    if ("undefined" !== typeof f.getElementById && !c)
                        return (b = f.getElementById(b)) && b.parentNode ? [b] : [];
                } : function(b, f, c) {
                    if ("undefined" !== typeof f.getElementById && !c)
                        return (f = f.getElementById(b)) ?
                            f.id === b ||
                            ("undefined" !== typeof f.getAttributeNode &&
                                f.getAttributeNode("id").value === b) ? [f] :
                            void 0 : [];
                },
            TAG: dd ?
                function(b, f) {
            ...
            NAME: gd &&
                function(b, f) {
                    if ("undefined" !== typeof f.getElementsByName)
                        return f.getElementsByName(name);
                },
            CLASS: Tb &&
                function(b, f, c) {
                    if ("undefined" !== typeof f.getElementsByClassName && !c)
        ...
        preFilter: {
            ...
            PSEUDO: function(b) {
                ...
                if (b[3]) b[2] = b[3];
                    ...
                    ad.test(f) &&
                    (c = Pa(f, !0)) &&
                    (c = f.indexOf(")", f.length - c) - f.length) &&
                    ((f = f.slice(0, c)), (b[0] = b[0].slice(0, c))),
                    (b[2] = f);
                return b.slice(0, 3);
            },
        },
                ...
                return function(d) {
                    ...
                    return null == d ?
                        ...
                        ((d += ""),
                            ...
                            c && -1 < d.indexOf(c) :
                            "$=" === f ?
                            c && d.substr(d.length - c.length) === c :
                            "~=" === f ?
                            -1 < (" " + d + " ").indexOf(c) :
                            "|=" === f ?
                            d === c || d.substr(0, c.length + 1) === c + "-" :
                            !1) :
                        !0;
                };
            },
                ...
                return "nth" === b ?
                    function(b) {
                        ...
                        if (c) {
                            f = 0;
                            for (
                                c = c.firstChild; c && !(1 === c.nodeType && (f++, b === c)); c = c.nextSibling
                            );
                        }
            ...
            PSEUDO: function(b, c) {
                ...
                return e[P] ?
                    ...
                    ((d = [b, b, "", c]),
                        ...
                        Y(function(b, d) {
                            for (var u, l = e(b, c), q = l.length; q--;)
                                (u = Xb.call(b, l[q])), (b[u] = !(d[u] = l[q]));
                        }) :
                        function(b) {
                            return e(b, 0, d);
                        }) :
        ...
        if (!g) {
            ...
            var m = 0 < e.length,
                ...
                p = function(b, c, f, d, u) {
                    ...
                    for (
                        z && ((Ra = c !== X && c), (fb = p.el)); null != (u = A[r]); r++
                    ) {
                        if (j && u) {
                            for (q = 0;
                                (g = l[q]); q++)
    ...
    if (X.querySelectorAll) {
        ...
        Ua &&
            (da(function(b) {
                ...
                (Ta = RegExp(Ta.join("|"))),
                (I.matchesSelector = function(b, c) {
                    c = c.replace(jd, "='$1']");
    ...
    e.fn.extend({
        ...
        is: function(b) {
            return (
                ...
                ("string" == typeof b ?
                    dc.test(b) ?
                    0 <= e(b, this.context).index(this[0]) :
                    0 < e.filter(b, this).length :
        ...
        closest: function(b, c) {
            for (
                var d,
                    ...
                    g = this.length,
                    j = [],
                    m = dc.test(b) || "string" != typeof b ? e(b, c || this.context) : 0; l < g; l++
            )
                for (
                    d = this[l]; d && d.ownerDocument && d !== c && 11 !== d.nodeType;
            ...
            return (
                (j = 1 < j.length ? e.unique(j) : j), this.pushStack(j, "closest", b)
            );
        },
        index: function(b) {
            return b ?
                "string" == typeof b ?
                e.inArray(this[0], e(b)) :
                e.inArray(b.jquery ? b[0] : b, this) :
    ...
    e.each({
        ...
        function(b, c) {
            e.fn[b] = function(d, l) {
                ...
                return (
                    kd.test(b) || (l = d),
                    l && "string" == typeof l && (g = e.filter(l, g)),
                    (g = 1 < this.length && !md[b] ? e.unique(g) : g),
    ...
    e.extend({
        filter: function(b, c, d) {
            return (
                d && (b = ":not(" + b + ")"),
                1 === c.length ?
                e.find.matchesSelector(c[0], b) ? [c[0]] : [] :
                e.find.matches(b, c)
            );
        },
        dir: function(b, f, d) {
            var l = [];
            for (
                b = b[f]; b && 9 !== b.nodeType && (d === c || 1 !== b.nodeType || !e(b).is(d));

            )
                1 === b.nodeType && l.push(b), (b = b[f]);
            return l;
        },
    ...
    e.fn.extend({
        ...
        remove: function(b, c) {
            for (var d, l = 0; null != (d = this[l]); l++)
                if (!b || e.filter(b, [d]).length)
                    !c &&
                    1 === d.nodeType &&
                    (e.cleanData(d.getElementsByTagName("*")), e.cleanData([d])),
        ...
        empty: function() {
            for (var b, c = 0; null != (b = this[c]); c++)
                for (
                    1 === b.nodeType && e.cleanData(b.getElementsByTagName("*")); b.firstChild;
            ...
            return e.access(
                ...
                function(b) {
                    ...
                    if (
                        "string" == typeof b &&
                        !qd.test(b) &&
                        (e.support.htmlSerialize || !rb.test(b)) &&
                        (e.support.leadingWhitespace || !qb.test(b)) &&
        ...
        replaceWith: function(b) {
            return y(this[0]) ?
                this.length ?
                this.pushStack(e(e.isFunction(b) ? b() : b), "replaceWith", b) :
                this :
                e.isFunction(b) ?
                this.each(function(c) {
                    var d = e(this),
        ...
        domManip: function(b, f, d) {
            ...
            if (this[0]) {
                ...
                if (g) {
                    f = f && e.nodeName(g, "tr");
                    for (l = l.cacheable || r - 1; m < r; m++)
                        d.call(
                            f && e.nodeName(this[m], "table") ?
                            this[m].getElementsByTagName("tbody")[0] ||
                            this[m].appendChild(
                                this[m].ownerDocument.createElement("tbody")
                            ) :
                            this[m],
                            m === l ? j : e.clone(j, !0, !0)
                        );
    ...
    e.buildFragment = function(b, f, d) {
        ...
        return (
            ...
            "<" === m.charAt(0) &&
            !rd.test(m) &&
            (e.support.checkClone || !gc.test(m)) &&
            (e.support.html5Clone || !rb.test(m)) &&
            ((g = !0), (l = e.fragments[m]), (j = l !== c)),
            l ||
            ((l = f.createDocumentFragment()),
                e.clean(b, f, l, d),
                g && (e.fragments[m] = j && l)), {
                fragment: l,
                cacheable: g,
    ...
    e.extend({
        clone: function(b, c, d) {
            ...
            e.support.html5Clone || e.isXMLDoc(b) || !rb.test("<" + b.nodeName + ">") ?
                (m = b.cloneNode(!0)) :
                ((sb.innerHTML = b.outerHTML), sb.removeChild((m = sb.firstChild)));
            if (
        ...
        clean: function(b, c, d, l) {
                        ...
                        if (pd.test(m)) {
                            ...
                            if (!e.support.tbody) {
                                ...
                                p =
                                    ...
                                    "<table>" === p[1] && !r ?
                                    n.childNodes : [];
                                for (j = p.length - 1; 0 <= j; --j)
                                    e.nodeName(p[j], "tbody") &&
                                    !p[j].childNodes.length &&
                                    p[j].parentNode.removeChild(p[j]);
                            }!e.support.leadingWhitespace &&
                                qb.test(m) &&
                                n.insertBefore(c.createTextNode(qb.exec(m)[0]), n.firstChild);
                            m = n.childNodes;
            ...
            if (!e.support.appendChecked)
                for (g = 0; null != (m = B[g]); g++)
                    ...
                    e.grep(m.getElementsByTagName("input"), t);
            if (d) {
                b = function(b) {
                ...
                for (g = 0; null != (m = B[g]); g++)
                    if (!e.nodeName(m, "script") || !b(m))
                        d.appendChild(m),
                        "undefined" != typeof m.getElementsByTagName &&
                        ((z = e.grep(e.merge([], m.getElementsByTagName("script")), b)),
                            B.splice.apply(B, [g + 1, 0].concat(z)),
                            (g += z.length));
            }
            return B;
        },
        cleanData: function(b, c) {
            for (
                var d,
                    ...
                    p = e.expando,
                    t = e.cache,
                    r = e.support.deleteExpando,
                    n = e.event.special; null != (g = b[m]); m++
            )
                if (c || e.acceptData(g))
                    if ((d = (l = g[p]) && t[l])) {
                        if (d.events)
                            for (j in d.events)
                                n[j] ? e.event.remove(g, j) : e.removeEvent(g, j, d.handle);
                        t[l] &&
                            (delete t[l],
                                r ?
                                delete g[p] :
    ...
    e.sub = function() {
        ...
        b.fn.init = function(d, l) {
            return (
                l && l instanceof e && !(l instanceof b) && (l = b(l)),
    ...
    e.fn.extend({
        ...
        toggle: function(b, c) {
            ...
            return e.isFunction(b) && e.isFunction(c) ?
    ...
    e.extend({
        ...
        style: function(b, d, l, g) {
            if (b && !(3 === b.nodeType || 8 === b.nodeType || !b.style)) {
                ...
                if (l === c)
                    return m && "get" in m && (j = m.get(b, !1, g)) !== c ? j : r[d];
                p = typeof l;
                "string" === p &&
                    (j = xd.exec(l)) &&
                    ((l = (j[1] + 1) * j[2] + parseFloat(e.css(b, d))), (p = "number"));
                if (!(null == l || ("number" === p && isNaN(l))))
                    if (
                        ("number" === p && !e.cssNumber[t] && (l += "px"),
                            !m || !("set" in m) || (l = m.set(b, l, g)) !== c)
                    )
                        try {
                            r[d] = l;
                        } catch (n) {}
        ...
        css: function(b, d, l, g) {
            var j,
                ...
                t = e.camelCase(d);
            return (
                (d = e.cssProps[t] || (e.cssProps[t] = x(b.style, t))),
                (m = e.cssHooks[d] || e.cssHooks[t]),
                m && "get" in m && (j = m.get(b, !0, g)),
                j === c && (j = R(b, d)),
                "normal" === j && d in jc && (j = jc[d]),
                l || g !== c ?
                ((p = parseFloat(j)), l || e.isNumeric(p) ? p || 0 : j) :
                j
            );
        },
        swap: function(b, c, d) {
            ...
            return (
                ...
                ((l = m[d]),
                    ...
                    ((g = t.width),
                        (j = t.minWidth),
                        (p = t.maxWidth),
                        (t.minWidth = t.maxWidth = t.width = l),
                        (l = m.width),
                        (t.width = g),
                        (t.minWidth = j),
                        (t.maxWidth = p))),
    ...
    e.each(["height", "width"], function(b, c) {
        e.cssHooks[c] = {
            get: function(b, d, l) {
                if (d)
                    return 0 === b.offsetWidth && wd.test(R(b, "display")) ?
                        e.swap(b, yd, function() {
                            return F(b, c, l);
                        }) :
                        F(b, c, l);
            },
            set: function(b, d, l) {
                return E(
                    ...
                    N(
                        ...
                        c,
                        l,
                        e.support.boxSizing && "border-box" === e.css(b, "boxSizing")
                    ) :
                    0
                );
            },
        ...
        (e.cssHooks.opacity = {
            ...
            set: function(b, c) {
                ...
                if (
                    ...
                    d.filter = tb.test(j) ? j.replace(tb, g) : j + " " + g;
            },
        });
    e(function() {
    ...
    e.fn.load = function(b, d, l) {
        ...
        var g,
            ...
            t = b.indexOf(" ");
        return (
            0 <= t && ((g = b.slice(t, b.length)), (b = b.slice(0, t))),
            e.isFunction(d) ?
            ((l = d), (d = c)) :
            d && "object" == typeof d && (j = "POST"),
            e
            .ajax({
                url: b,
                type: j,
    ...
    e.extend({
        ...
        ajaxSetup: function(b, c) {
            return (
                c ? ta(b, e.ajaxSettings) : ((c = b), (b = e.ajaxSettings)), ta(b, c), b
            );
        },
        ajaxSettings: {
            url: la,
        ...
        ajax: function(b, d) {
                ...
                if (2 !== F) {
                    ...
                    if (f) {
                        ...
                        for (;
                            ...
                            K.shift(),
                            H === c &&
                            (H = s.mimeType || p.getResponseHeader("content-type"));
                        if (H)
                            for (S in N)
                                if (N[S] && N[S].test(H)) {
                                    K.unshift(S);
                    ...
                    if ((200 <= b && 300 > b) || 304 === b)
                        if (
                            (x.ifModified &&
                                ((z = J.getResponseHeader("Last-Modified")),
                                    z && (e.lastModified[g] = z),
                                    (z = J.getResponseHeader("Etag")),
                                    z && (e.etag[g] = z)),
                                304 === b)
                        )
                            (E = "notmodified"), (u = !0);
                ...
                J = {
                    ...
                    getResponseHeader: function(b) {
                        ...
                        if (2 === F) {
                            if (!p)
                                for (p = {};
                                    (d = Ed.exec(j));) p[d[1].toLowerCase()] = d[2];
                            d = p[b.toLowerCase()];
                        }
                        return d === c ? null : d;
                    },
            ...
            x.data &&
                ...
                (x.data = e.param(x.data, x.traditional));
            oa(Za, x, d, J);
            if (2 === F) return J;
            n = x.global;
            ...
            if (
                !x.hasContent &&
                (x.data &&
                    ((x.url += (lc.test(x.url) ? "&" : "?") + x.data), delete x.data),
                    (g = x.url),
                    !1 === x.cache)
            ) {
                r = e.now();
                ...
                x.url =
                    N + (N === x.url ? (lc.test(x.url) ? "&" : "?") + "_=" + r : "");
            }
            ((x.data && x.hasContent && !1 !== x.contentType) || d.contentType) &&
            J.setRequestHeader("Content-Type", x.contentType);
            x.ifModified &&
                ((g = g || x.url),
                    e.lastModified[g] &&
                    J.setRequestHeader("If-Modified-Since", e.lastModified[g]),
                    e.etag[g] && J.setRequestHeader("If-None-Match", e.etag[g]));
            J.setRequestHeader(
                "Accept",
                x.dataTypes[0] && x.accepts[x.dataTypes[0]] ?
                x.accepts[x.dataTypes[0]] +
                ("*" !== x.dataTypes[0] ? ", " + pc + "; q=0.01" : "") :
                x.accepts["*"]
            );
    ...
    e.ajaxPrefilter("json jsonp", function(d, f, l) {
        var g,
            ...
            Wa.test(m);
        if ("jsonp" === d.dataTypes[0] || n || x)
            return (
                (g = d.jsonpCallback =
                    e.isFunction(d.jsonpCallback) ? d.jsonpCallback() : d.jsonpCallback),
                (j = b[g]),
                n ?
                (d.url = t.replace(Wa, "$1" + g)) :
                x ?
                (d.data = m.replace(Wa, "$1" + g)) :
                r && (d.url += (Jd.test(t) ? "&" : "?") + d.jsonp + "=" + g),
                        ...
                        f = function(b, l) {
                            ...
                            try {
                                if (f && (l || 4 === m.readyState))
                                    if (
                                        ((f = c),
                                            j && ((m.onreadystatechange = e.noop), ub && delete sa[j]),
                                            l)
                                    )
        ...
        Ca = [
            function(b, c, d) {
                ...
                1 === b.nodeType &&
                    ...
                    ((d.overflow = [x.overflow, x.overflowX, x.overflowY]),
                        "inline" === e.css(b, "display") &&
                        "none" === e.css(b, "float") &&
                        (!e.support.inlineBlockNeedsLayout || "inline" === K(b.nodeName) ?
                ...
                for (l in c)
                    (g = c[l]),
                    Md.exec(g) &&
                    (delete c[l], g !== (B ? "hide" : "show") && A.push(l));
                if ((g = A.length)) {
    ...
    e.Animation = e.extend(Bb, {
        tweener: function(b, c) {
            ...
            for (var d, l = 0, g = b.length; l < g; l++)
                (d = b[l]), (ua[d] = ua[d] || []), ua[d].unshift(c);
        },
        ...
        _default: {
            get: function(b) {
                ...
                return null == b.elem[b.prop] ||
                    ...
                    ((c = e.css(b.elem, b.prop, !1, "")), !c || "auto" === c ? 0 : c) :
                    b.elem[b.prop];
            },
            set: function(b) {
                e.fx.step[b.prop] ?
                    e.fx.step[b.prop](b) :
                    b.elem.style &&
                    (null != b.elem.style[e.cssProps[b.prop]] || e.cssHooks[b.prop]) ?
                    e.style(b.elem, b.prop, b.now + b.unit) :
                    (b.elem[b.prop] = b.now);
            },
        },
    };
    ...
    e.each(["toggle", "show", "hide"], function(b, c) {
        ...
        e.fn[c] = function(l, g, j) {
            return null == l ||
                "boolean" == typeof l ||
                (!b && e.isFunction(l) && e.isFunction(g)) ?
                d.apply(this, arguments) :
                this.animate(Da(c, !0), l, g, j);
        };
    });
    e.fn.extend({
            ...
            return (
                ...
                this.each(function() {
                    ...
                    if (d) j[d] && j[d].stop && g(j[d]);
                        ...
                        for (d in j) j[d] && j[d].stop && Od.test(d) && g(j[d]);
                    for (d = f.length; d--;)
                        f[d].elem === this &&
                        (null == b || f[d].queue === b) &&
    ...
    e.speed = function(b, c, d) {
        ...
        l.duration = e.fx.off ?
            ...
            l.duration :
            l.duration in e.fx.speeds ?
            e.fx.speeds[l.duration] :
    ...
    e.fx.timer = function(b) {
        b() &&
            e.timers.push(b) &&
            !Xa &&
            (Xa = setInterval(e.fx.tick, e.fx.interval));
    };
    e.fx.interval = 13;
    e.fx.stop = function() {
        clearInterval(Xa);
    ...
    e.fn.offset = function(b) {
        ...
        if (x)
            return (l = x.body) === n ?
                e.offset.bodyOffset(n) :
                ((d = x.documentElement),
                    e.contains(d, n) ?
                    ("undefined" != typeof n.getBoundingClientRect &&
                        (r = n.getBoundingClientRect()),
                        (g = Cb(x)),
                        (j = d.clientTop || l.clientTop || 0),
                        (p = d.clientLeft || l.clientLeft || 0),
                        (m = g.pageYOffset || d.scrollTop),
                        (t = g.pageXOffset || d.scrollLeft), {
                            top: r.top + m - j,
                            left: r.left + t - p,
                        }) :
                    r);
    ...
    e.offset = {
        bodyOffset: function(b) {
            ...
            return (
                ...
                ((c += parseFloat(e.css(b, "marginTop")) || 0),
        ...
        setOffset: function(b, c, d) {
            ...
            var g = e(b),
                ...
                x,
                z;
            ("absolute" === l || "fixed" === l) && -1 < e.inArray("auto", [p, t]) ?
                ((n = g.position()), (x = n.top), (z = n.left)) :
                ((x = parseFloat(p) || 0), (z = parseFloat(t) || 0));
            e.isFunction(c) && (c = c.call(b, d, j));
            null != c.top && (r.top = c.top - j.top + x);
    ...
    e.fn.extend({
        position: function() {
            if (this[0]) {
                var b = this[0],
                    ...
                    c.offset();
                return (
                    (d.top -= parseFloat(e.css(b, "marginTop")) || 0),
        ...
        offsetParent: function() {
            return this.map(function() {
                for (
                    var b = this.offsetParent || D.body; b && !rc.test(b.nodeName) && "static" === e.css(b, "position");
            ...
            e.fn[b] = function(g) {
                return e.access(
                    ...
                    function(b, g, j) {
                        var p = Cb(b);
                        if (j === c)
                            return p ? (d in p ? p[d] : p.document.documentElement[g]) : b[g];
                        p
                            ?
                            p.scrollTo(l ? e(p).scrollLeft() : j, l ? j : e(p).scrollTop()) :
                            (b[g] = j);
                    },
                    b,
                    g,
...
function sizeHandler() {
    if ($("#game")) {
        ...
        for (
            var b = navigator.userAgent.split(" "), c = null, d = 0; d < b.length; d++
        )
            "Version/" == b[d].substr(0, 8) && (c = b[d]);
        var b = window.chrome,
            d = navigator.userAgent.indexOf("wv"),
            g = navigator.userAgent.indexOf("SamsungBrowser"); -
        1 < navigator.userAgent.indexOf("Chrome") &&
            ...
            void 0 !== b &&
            $(window) &&
            ((c = document.getElementById("scrollDown")),
                ...
                window.addEventListener("resize", function() {
                    ...
                    if (90 == Math.abs(window.orientation)) {
                        ...
                        b.clientHeight + c.clientHeight > minHeight ?
                            $("#scrollDown").hide() :
                            $("#scrollDown").show();
                    }
                })) :
...
function getQueryVariable(b) {
    for (
        var c = window.location.search.substring(1).split("&"), d = 0; d < c.length; d++
    ) {
        var g = c[d].split("=");
        ...
        if (null !== this.isPlaying && !0 !== c)
            ...
            void 0 !== g &&
                ...
                ((this.isPlaying = this.settings.spritemap[b]),
                    ...
                    (this.wasReady = this.setCurrentTime(g)));
        }
    },
    stop: function() {
...
(function() {
    ...
    y.prototype = {
        ...
        _setMuted: function(b) {
            ...
            for (var c in this._howls)
                if (this._howls.hasOwnProperty(c) && !1 === this._howls[c]._webAudio)
                    for (var g = 0; g < this._howls[c]._audioNode.length; g++)
                        this._howls[c]._audioNode[g].muted = b;
        },
    };
    var r = new y(),
        y = null;
    ...
    A.prototype = {
            ...
            if (!g) {
                for (var t = 0; t < d._urls.length; t++) {
                    ...
                    if (d._format) n = d._format;
                        ...
                        ((A = d._urls[t].toLowerCase().split("?")[0]),
                            (n =
                                (n = A.match(/.+\.([^?]+)(\?|$)/)) && 2 <= n.length ?
                                n :
                                A.match(/data\:audio\/([^?]+);/)))
                    )
                        n = n[1];
        ...
        play: function(d, g) {
            ...
            j._inactiveNode(function(n) {
                ...
                F = setTimeout(function() {
                    ...
                    j._webAudio &&
                        !B &&
                        ((j._nodeById(K.id).paused = !0), (j._nodeById(K.id)._pos = 0));
                ...
                if (j._webAudio) {
                    ...
                    O.bufferSource.buffer = b[j._src];
                    O.bufferSource.connect(O.panner);
                    O.bufferSource.loop = F[0];
                    F[0] &&
                        ((O.bufferSource.loopStart = F[1]),
                            (O.bufferSource.loopEnd = F[1] + F[2]));
                    O.bufferSource.playbackRate.value = j._rate;
                    j._playStart = c.currentTime;
                    n.gain.value = j._volume;
                    "undefined" === typeof n.bufferSource.start ?
                        n.bufferSource.noteGrainOn(0, z, A) :
                        n.bufferSource.start(0, z, A);
                } else if (4 === n.readyState)
                    (n.id = y),
                    (n.currentTime = z),
                    (n.muted = r._muted),
                    (n.volume = j._volume * r.volume()),
                    setTimeout(function() {
                        n.play();
                    }, 0);
                else {
        ...
        pause: function(b, c) {
            ...
            if (g)
                if (((g._pos = d.pos(null, b)), d._webAudio)) {
                    ...
                    g.paused = !0;
                    "undefined" === typeof g.bufferSource.stop ?
                        g.bufferSource.noteOff(0) :
        ...
        volume: function(b, c) {
            ...
            if (0 <= b && 1 >= b) {
                ...
                g && (d._webAudio ? (g.gain.value = b) : (g.volume = b * r.volume()));
                return d;
            }
            return d._volume;
        },
        ...
        pos: function(b, d) {
            ...
            if (j)
                return 0 <= b ?
                    (g.pause(d), (j._pos = b), g.play(j._sprite, d), g) :
                    g._webAudio ?
                    j._pos + (c.currentTime - g._playStart) :
                    j.currentTime;
            if (0 <= b) return g;
            for (j = 0; j < g._audioNode.length; j++)
                if (g._audioNode[j].paused && 4 === g._audioNode[j].readyState)
                    return g._webAudio ?
                        g._audioNode[j]._pos :
                        g._audioNode[j].currentTime;
        },
        ...
        fade: function(b, c, d, g, j) {
            ...
            for (var B = 1; B <= n; B++)
                (function() {
                    var b =
                        Math.round(1e3 * (r._volume + ("up" === z ? 0.01 : -0.01) * B)) /
                        1e3;
                    setTimeout(function() {
                        r.volume(b, j);
                        b === c && g && g();
        ...
        _inactiveNode: function(b) {
            ...
            if (!c) {
                var g;
                this._webAudio ?
                    ((g = this._setupAudioNode()), b(g)) :
                    (this.load(),
                        (g = this._audioNode[this._audioNode.length - 1]),
        ...
        on: function(b, c) {
            ...
            if ("function" === typeof c) d.push(c);
                ...
                for (var g = 0; g < d.length; g++)
                    c ? d[g].call(this, c) : d[g].call(this);
            return this;
        },
        off: function(b, c) {
...
(function(b) {
    ...
    b.ig = {
        ...
        merge: function(b, c) {
            for (var d in c) {
                ...
                if (
                    ...
                    g instanceof ig.Class ||
                    null === g
                )
                    b[d] = g;
                else {
                    if (!b[d] || "object" != typeof b[d])
                        b[d] = g instanceof Array ? [] : {};
                    ig.merge(b[d], g);
                }
            }
            return b;
        ...
        setVendorAttribute: function(b, c, d) {
            ...
            b[c] =
                ...
                (b["ms" + g] = b["moz" + g] = b["o" + g] = d) :
                (b["ms" + g] = b["moz" + g] = b["webkit" + g] = b["o" + g] = d);
        },
        ...
        getImagePixels: function(b, c, d, g, j) {
            ...
            return 1 === x ?
                n.getImageData(c, d, g, j) :
                n.getImageDataHD(c, d, g, j);
        },
        module: function(b) {
            if (ig._current)
        ...
        _execModules: function() {
            for (var b = !1, c = 0; c < ig._loadQueue.length; c++) {
                for (
                    var d = ig._loadQueue[c], g = !0, j = 0; j < d.requires.length; j++
                ) {
                    var n = d.requires[j];
                    ig.modules[n] ?
                        ig.modules[n].loaded || (g = !1) :
                        ((g = !1), ig._loadScript(n, d.name));
                }
                g &&
                    d.body &&
            ...
            if (b) ig._execModules();
                ...
                for (c = 0; c < ig._loadQueue.length; c++) {
                    ...
                    for (j = 0; j < n.length; j++)
                        (d = ig.modules[n[j]]), (!d || !d.loaded) && g.push(n[j]);
    ...
    var y = function(b) {
        var c = this.prototype,
            ...
            g;
        for (g in b)
            "function" == typeof b[g] && "function" == typeof c[g] && j.test(b[g]) ?
            ((d[g] = c[g]),
                (c[g] = (function(b, c) {
                    return function() {
                        var g = this.parent;
    ...
    b.ig.Class.extend = function(c) {
        ...
        for (var l in c)
            B[l] =
            "function" == typeof c[l] && "function" == typeof A[l] && j.test(c[l]) ?
            (function(b, c) {
                return function() {
                    var d = this.parent;
                    this.parent = A[b];
...
ig.module("impact.image").defines(function() {
    ig.Image = ig.Class.extend({
        ...
        resize: function(b) {
            ...
            j.height = g;
            for (
                var n = j.getContext("2d"), y = n.getImageData(0, 0, d, g), r = 0; r < g; r++
            )
                for (var z = 0; z < d; z++) {
        ...
        drawTile: function(b, c, d, g, j, n, y) {
            ...
            if (this.loaded && !(g > this.width || j > this.height)) {
                ...
                ig.system.context.drawImage(
                    this.data,
                    (Math.floor(d * g) % this.width) * r,
                    Math.floor((d * g) / this.width) * j * r,
                    z,
                    A,
                    ig.system.getDrawPos(b) * B - (n ? z : 0),
                    ig.system.getDrawPos(c) * l - (y ? A : 0),
                    z,
                    A
                );
                (n || y) && ig.system.context.restore();
                ig.Image.drawCount++;
            }
        },
    });
    ...
    .defines(function() {
        ig.Font = ig.Image.extend({
            ...
            draw: function(b, c, d, g) {
                ...
                if (-1 !== b.indexOf("\n")) {
                    b = b.split("\n");
                    for (var j = this.height + this.lineSpacing, n = 0; n < b.length; n++)
                        this.draw(b[n], c, d + n * j, g);
                } else {
                    if (g == ig.Font.ALIGN.RIGHT || g == ig.Font.ALIGN.CENTER)
                        (n = this._widthForLine(b)),
                        (c -= g == ig.Font.ALIGN.CENTER ? n / 2 : n);
            ...
            _loadMetrics: function(b) {
                ...
                for (
                    ...
                    127 < c.data[n] ?
                        ...
                        128 > c.data[n] &&
                        g &&
                        (this.widthMap.push(g), this.indices.push(j - g), d++, (g = 0));
                }
        ...
        load: function(b, c, d) {
            ...
            if (c)
                for (c = 1; c < ig.Sound.channels; c++)
                    (j = new Audio(g)), j.load(), this.clips[b].push(j);
            return n;
        },
        get: function(b) {
            b = this.clips[b];
        ...
        ig.Entity.seperateOnYAxis = function(b, c, d) {
            ...
            if (d) {
                ...
                d == b &&
                    ...
                    ((d.standing = !0), (j = c.vel.x * ig.system.tick));
                b = ig.game.collisionMap.trace(
                    d.pos.x,
                    d.pos.y,
                    j,
...
ig.module("impact.map").defines(function() {
    ig.Map = ig.Class.extend({
        ...
        getTile: function(b, c) {
            ...
            return 0 <= d && d < this.width && 0 <= g && g < this.height ?
                this.data[g][d] :
                0;
        },
    ...
    .defines(function() {
        ig.CollisionMap = ig.Map.extend({
            ...
            trace: function(b, c, j, n, y, r) {
                ...
                if (1 < A)
                    for (
                        var B = j / A, l = n / A, p = 0; p < A &&
                        (B || l) &&
                        !(this._traceStep(z, b, c, B, l, y, r, j, n, p),
                            (b = z.pos.x),
                            (c = z.pos.y),
                            z.collision.x && (j = B = 0),
                            z.collision.y && (n = l = 0),
                        ...
                        for (
                            ...
                            !(
                                ...
                                ((p = this.data[E][H]),
                                    1 < p &&
                                    p <= this.lastSlope &&
                                    this._checkTileDef(b, p, c, j, A, B, r, z, H, E))
                            ); E++
                        )
                            if (
                                ((p = this.data[E][n]),
                                    1 == p ||
                                    p > this.lastSlope ||
                                    (1 < p && this._checkTileDef(b, p, c, j, A, B, r, z, n, E)))
                            ) {
                        ...
                        for (
                            ...
                            !(
                                ...
                                ((p = this.data[L][n]),
                                    1 < p &&
                                    p <= this.lastSlope &&
                                    this._checkTileDef(b, p, c, j, A, B, r, z, n, L))
                            ); n++
                        )
                            if (
                                ((p = this.data[E][n]),
        ...
        ig.BackgroundMap = ig.Map.extend({
            ...
            preRenderMapToChunks: function() {
                ...
                for (var j = 0; j < g; j++) {
                    ...
                    for (var n = 0; n < d; n++)
                        this.preRenderedChunks[j][n] = this.preRenderChunk(
                            n,
                            j,
                            n == d - 1 ? b - n * this.chunkSize : this.chunkSize,
                            j == g - 1 ? c - j * this.chunkSize : this.chunkSize
                        );
                }
            },
                ...
                for (var z = 0; g < n; g++) {
                    for (var A = 0, B = d; B < j; B++) {
                        ...
                        this.repeat &&
                            ...
                            p + l.width < ig.system.realWidth &&
                            ((A += this.chunkSize - l.width), j++);
                    }
                    this.repeat &&
                        l.height < this.chunkSize &&
                        t + l.height < ig.system.realHeight &&
                        ((z += this.chunkSize - l.height), n++);
                }
            },
            drawTiled: function() {
                for (
                    var b = 0,
                        ...
                        g = (this.scroll.y / this.tilesize).toInt(),
                        j = this.scroll.x % this.tilesize,
                        n = this.scroll.y % this.tilesize,
                        y = -j - this.tilesize,
                        j = ig.system.width + this.tilesize - j,
                        r = ig.system.height + this.tilesize - n,
                        z = -1,
                        n = -n - this.tilesize; n < r; z++, n += this.tilesize
                ) {
                    var A = z + g;
                    ...
                    for (var B = -1, l = y; l < j; B++, l += this.tilesize) {
                        ...
                        if ((b = this.data[A][b]))
                            (c = this.anims[b - 1]) ?
                            c.draw(l, n) :
                            this.tiles.drawTile(l, n, b - 1, this.tilesize);
                    }
                }
            },
        });
            ...
            checkEntities: function() {
                for (var b = {}, c = 0; c < this.entities.length; c++) {
                    ...
                    if (
                        ...
                        for (
                            var g = {},
                                j = Math.floor(d.pos.y / this.cellSize),
                                n = Math.floor((d.pos.x + d.size.x) / this.cellSize) + 1,
                                y = Math.floor((d.pos.y + d.size.y) / this.cellSize) + 1,
                                r = Math.floor(d.pos.x / this.cellSize); r < n; r++
                        )
                            for (var z = j; z < y; z++)
                                if (b[r])
                                    if (b[r][z]) {
                                        for (var A = b[r][z], B = 0; B < A.length; B++)
                                            d.touches(A[B]) &&
                                            !g[A[B].id] &&
                                            ((g[A[B].id] = !0), ig.Entity.checkPair(d, A[B]));
                                        A.push(d);
                                    } else b[r][z] = [d];
                    else(b[r] = {}), (b[r][z] = [d]);
                }
    ...
    .defines(function() {
        ig.SplashLoader = ig.Loader.extend({
            ...
            textSet: function(b, c, d) {
                b =
                    "bg" == b ? ig.system.bgcontext : "game" == b ? ig.system.context : b;
                b.font = c + "px tex";
                b.fillStyle = d;
            },
                ...
                try {
                    ...
                    null == l || 0 == l ?
                        ((n = A ? n - F / 2 + p : n + p),
                            ...
                            0 < N &&
                            ((x.globalAlpha = B),
                                x.drawImage(c.data, L, H, E, N, n, y, F, K),
                                (x.globalAlpha = 1))) :
                        ((p = A ? -E / 2 + p : p || 0),
                            (t = A ? -N / 2 + t : t || 0),
                            0 < E &&
                            ...
                            (x.save(),
                                x.translate(n, y),
                                x.scale(r, z),
                                x.rotate(((2 * Math.PI) / 360) * l),
                                (x.globalAlpha = B),
                                x.drawImage(c.data, L, H, E, N, p, t, E, N),
                                x.restore()));
                } catch (O) {
                    console.log(c);
                }
            ...
            draw: function() {
                ...
                1 < this.count ?
                    ((this.count = 0),
                        (this.plane.frame =
                            (this.plane.frame + 1) % this.plane.frames.length),
                        (this.scarf.frame =
                            (this.scarf.frame + 1) % this.scarf.frames.length),
                        (this.fan.frame = (this.fan.frame + 1) % this.fan.frames.length)) :
                    this.count++;
                this.tweenHolder({
                        targ: "logo",
                        inner: "scX",
                ...
                this.drawer(
                    ...
                    2,
                    2,
                    this.plane.frames[this.plane.frame],
                    this.plane.x,
                    this.plane.y,
                    this.plane.sc,
                    this.plane.sc,
                ...
                this.drawer(
                    ...
                    this.plane.x + this.scarf.x,
                    this.plane.y + this.scarf.y + this.fan.offY[this.plane.frame],
                    this.scarf.sc,
                    this.scarf.sc,
                    !0
                );
                this.drawer(
                    ...
                    4,
                    1,
                    this.fan.frames[this.fan.frame],
                    this.plane.x + this.fan.x,
                    this.plane.y + this.fan.y + this.fan.offY[this.plane.frame],
                    this.fan.sc,
                    this.fan.sc,
                    !0
                );
                ...
                this.ctx.fillRect(193, 387, 290 * this._drawStatus, 2);
                this.drawer(
                    "game",
                    this.miniIm,
                    4,
...
ig.module("plugins.tween")
    ...
    .defines(function() {
        ...
        ig.Tween = function(b, c, d, g) {
            ...
            this.initStart = function(b, c, d, g) {
                if ("object" !== typeof d[b])
                    "undefined" !== typeof c[b] && (g[b] = d[b]);
                else
                    for (subprop in d[b])
                        g[b] || (g[b] = {}),
                        "undefined" !== typeof c[b] &&
                        this.initStart(subprop, c[b], d[b], g[b]);
            };
            this.start = function() {
                this.paused = this.complete = !1;
                this.loopNum = this.loopCount;
            ...
            this.initDelta = function(b, c, d, g) {
                if ("object" !== typeof g[b]) c[b] = g[b] - d[b];
                    ...
                    for (subprop in g[b])
                        c[b] || (c[b] = {}), this.initDelta(subprop, c[b], d[b], g[b]);
            };
            this.propUpdate = function(b, c, d, g, j) {
                if ("object" !== typeof d[b])
                    c[b] = "undefined" != typeof d[b] ? d[b] + g[b] * j : c[b];
                else
        ...
        ig.Tween.Easing.Elastic.EaseIn = function(b) {
            ...
            !d || 1 > d ?
                ((d = 1), (c = g / 4)) :
                (c = (g / (2 * Math.PI)) * Math.asin(1 / d));
            return -(
                d *
                Math.pow(2, 10 * (b -= 1)) *
                Math.sin((2 * (b - c) * Math.PI) / g)
            );
        };
        ig.Tween.Easing.Elastic.EaseOut = function(b) {
            ...
            !d || 1 > d ?
                ...
                (c = (g / (2 * Math.PI)) * Math.asin(1 / d));
            return (
                d * Math.pow(2, -10 * b) * Math.sin((2 * (b - c) * Math.PI) / g) + 1
            );
        };
        ...
        EntityBranding = ig.Entity.extend({
            ...
            createClickableOutboundLayer: function(b, c, d, g) {
                ...
                if (ig.ua.mobile) {
                    ...
                    (y = h / 2 - destH / 2),
                    console.log(n, y),
                    $("#" + j.id).css("left", n + this.pos.x * multiplier),
                    $("#" + j.id).css("top", y + this.pos.y * multiplier),
        ...
        EntityButtonMoreGames = ig.Entity.extend({
            ...
            createClickableOutboundLayer: function(b, c, d, g) {
                ...
                if (ig.ua.mobile) {
                    ...
                    (n = document.getElementById("game").offsetLeft),
        ...
        EntityOpeningShield = ig.Entity.extend({
            ...
            drawOriginalShieldOpening: function() {
                if (this.moveTimer) {
                    ...
                    b.beginPath();
                    b.moveTo(0, 0);
                    for (var g = 0, j = 1; 48 >= j; j += 1)
                        b.lineTo(
                            0 + 800 * Math.cos((2 * j * Math.PI) / 48),
                            0 + 800 * Math.sin((2 * j * Math.PI) / 48)
                        ),
                        g++,
                        2 == g && ((g = 0), b.lineTo(0, 0));
                    b.translate(-c, -d);
        ...
        EntitySelect = ig.Entity.extend({
            ...
            createClickableOutboundLayer: function(b, c, d, g) {
                ...
                var n = w / 2 - destW / 2,
                    y = h / 2 - destH / 2;
                w == mobileWidth ?
                    ($("#" + j.id).css("left", this.pos.x),
                        $("#" + j.id).css("top", this.pos.y)) :
                    ($("#" + j.id).css("left", n + this.pos.x * multiplier),
                        $("#" + j.id).css("top", y + this.pos.y * multiplier));
                g
                    ?
                ...
                dynamicClickableEntityDivs[b].height = $("#" + j.id).height();
                dynamicClickableEntityDivs[b].entity_pos_x = this.pos.x;
                dynamicClickableEntityDivs[b].entity_pos_y = this.pos.y;
            },
            hovered: function() {
    ...
    .defines(function() {
        EntityPlain = ig.Entity.extend({
            ...
            soundLooper: function(b) {
                null == this[this.sLoop[b].id + "sTimer"] &&
                    ((this[this.sLoop[b].id + "sTimer"] = new ig.Timer()),
                        (this[this.sLoop[b].id + "sTime"] = this.sLoop[b].duration),
                        this.sounder(b));
                this[this.sLoop[b].id + "sTimer"].delta() >
                    this[this.sLoop[b].id + "sTime"] &&
            ...
            lookAt: function(b, c) {
                return Math.atan2(
                    c.y + c.size.y / 2 - (b.y + this.size.y / 2),
                    c.x + c.size.x / 2 - (b.x + this.size.x / 2)
                );
            },
            ...
            drawerOld: function(b, c, d, g, j, n, y, r, z, A, B) {
                ...
                if (null != z) {
                    ...
                    0 < p &&
                        ...
                        0 < c &&
                        0 < x &&
                        l.drawImage(b.data, d, 0, p, t, A, B, c, x);
                    l.restore();
                }
            },
            textSet: function(b, c, d) {
            ...
            getScore: function(b) {
                if (!this.checkNull(ig.game.storage) && this.supports_local_storage())
                    switch (b) {
                        case "score":
                            ig.game.storage.isSet(ig.game.scoreKey + ig.game.lvl) &&
                                void 0 != ig.game.storage.get(ig.game.scoreKey + ig.game.lvl) &&
                                (ig.game.rank = ig.game.storage.get(
                                    ig.game.scoreKey + ig.game.lvl
                                ));
                            break;
                        case "tut":
                            return ig.game.storage.isSet(ig.game.tutKey) &&
                                void 0 != ig.game.storage.get(ig.game.tutKey) ?
                                ig.game.storage.get(ig.game.tutKey) :
                                !1;
                    }
                else return !1;
            },
                    ...
                    switch (b) {
                        ...
                        case "rank":
                            if (
                                ...
                                for (
                                    var d = ig.game.storage.get(ig.game.scoreKey + ig.game.lvl),
                                        g = 0,
                                        j = 0; j < d.length; j++
                                )
                                    void 0 != d[j] && d[j].score > c && g++;
                                if (0 < g || 4 > d.length)
                                    d.push({
                                        score: c,
                                    }),
                        ...
                        case "tutOff":
                            ig.game.storage.isSet(ig.game.tutKey) &&
                                void 0 != ig.game.storage.get(ig.game.tutKey) ?
                                ig.game.storage.set(ig.game.tutKey, !1) :
                                ig.game.storage.set(ig.game.tutKey, !0);
                    }
            },
...
ig.module("game.entities.plain-home-but")
    ...
    .defines(function() {
        EntityPlainHomeBut = EntityPlain.extend({
            ...
            playIm: new ig.AnimationSheet(
                "media/graphics/sprites/play.png",
                173,
                123
            ),
            ...
            unmuteIm: new ig.AnimationSheet(
                "media/graphics/sprites/mute.png",
                50,
                48
            ),
            tutIm: new ig.AnimationSheet("media/graphics/sprites/tut.png", 48, 47),
            setIm: new ig.AnimationSheet(
                "media/graphics/sprites/setting.png",
                44,
                48
            ),
            muteAni: {},
            ...
            init: function(b, c, d) {
                ig.global.wm ||
                    ((this.main = d.main),
                        (this.seq = d.seq),
                        this.oriStat(),
                        this.parent(this.pos.x, this.pos.y, d),
                        this.spawner());
            },
            idle: function() {
                this.setScale(1, 1);
                ...
                if (!this.locked) {
                    ...
                    switch (this.seq) {
                        case 0:
                            ...
                            break;
                        case 2:
                            !0 == ig.soundHandler.muted ?
                                ((this.anims.idle = new ig.Animation(this.muteIm, 1, [0])),
                                    (this.anims.select = new ig.Animation(this.muteIm, 1, [1])),
                                    (this.anims.grey = new ig.Animation(this.muteIm, 1, [2])),
                                    ig.soundHandler.setForceMuted(!1),
                                    ig.soundHandler.unmute()) :
                                (ig.soundHandler.mute(),
                                    ig.soundHandler.setForceMuted(!0),
                                    (this.anims.idle = new ig.Animation(this.unmuteIm, 1, [0])),
                                    (this.anims.select = new ig.Animation(this.unmuteIm, 1, [1])),
                                    (this.anims.grey = new ig.Animation(this.unmuteIm, 1, [2]))),
            ...
            oriStat: function() {
                ...
                switch (this.seq) {
                    ...
                    case 2:
                        ...
                        this.pos.y = 10;
                        !0 == ig.soundHandler.muted ?
                            ((this.animSheet = this.unmuteIm),
                                (this.unmuteAni.idle = new ig.Animation(this.unmuteIm, 1, [0])),
                                (this.unmuteAni.select = new ig.Animation(this.unmuteIm, 1, [
                                    1,
                                ])),
                                (this.unmuteAni.grey = new ig.Animation(this.unmuteIm, 1, [2]))) :
                            ((this.animSheet = this.muteIm),
                                (this.muteAni.idle = new ig.Animation(this.muteIm, 1, [0])),
                                (this.muteAni.select = new ig.Animation(this.muteIm, 1, [1])),
                                (this.muteAni.grey = new ig.Animation(this.muteIm, 1, [2])));
                        break;
                    case 3:
                        this.pos.x = 586;
                        this.pos.y = 7;
            ...
            update: function() {
                ig.global.wm ||
                    (this.parent(),
                        2 == this.seq &&
                        !0 == ig.game.changeSound &&
                        ((ig.game.changeSound = !1),
                            !0 == ig.soundHandler.muted ?
                            ((this.anims.idle = new ig.Animation(this.unmuteIm, 1, [0])),
                                (this.anims.select = new ig.Animation(this.unmuteIm, 1, [1])),
                                (this.anims.grey = new ig.Animation(this.unmuteIm, 1, [2]))) :
                        ...
                        !this.locked &&
                        null != this.pointer &&
                        this.pointer.hoveringItem == this &&
                        !this.pointer.firstClick &&
                        (this.setScale(1, 1), (this.currentAnim = this.anims.select)));
            },
            drawInit: function() {},
            ready: function() {
                this.parent();
    ...
    .defines(function() {
        EntityPlainHome = EntityPlain.extend({
            ...
            spawner: function() {
                ...
                _SETTINGS.MoreGames.Enabled &&
                    ig.game.spawnEntity(EntityButtonMoreGames, 570, 423, {
                        main: this,
                        seq: b,
                    });
            },
...
ig.baked = !0;
ig.module("game.entities.plain-over-but")
    .requires("game.entities.plain")
    .defines(function() {
        EntityPlainOverBut = EntityPlain.extend({
            ...
            shopIm: new ig.AnimationSheet(
                "media/graphics/sprites/selectPlane.png",
                193.5,
                92
            ),
            mapIm: new ig.AnimationSheet(
                "media/graphics/sprites/map.png",
                506 / 3,
                91
            ),
            muteIm: new ig.AnimationSheet("media/graphics/sprites/sound.png", 50, 48),
            ...
            clicked: function() {
                if (!this.locked) {
                    ...
                    switch (this.seq) {
                        case 0:
                            !1 == ig.game.afterFirstPlay ?
                                (ig.game.afterFirstPlay = !0) :
                                (ig.game.seq = (ig.game.seq + 1) % ig.game.theme.length);
                    ...
                    (this.parent(),
                        ...
                        ((ig.game.changeSound = !1),
                            ...
                            ((this.anims.idle = new ig.Animation(this.muteIm, 1, [0])),
                                ...
                                (this.anims.grey = new ig.Animation(this.muteIm, 1, [2]))),
                            (this.currentAnim = this.anims.idle)),
                        !0 == this.main.tweening ?
                        (this.pos.y =
                            2 == this.seq ?
                            this.main.offY + this.oriY :
                            this.main.offUp + this.oriY) :
                        null != this.pointer &&
                        this.pointer.hoveringItem == this &&
                        !this.pointer.firstClick &&
                        (this.setScale(1, 1), (this.currentAnim = this.anims.select)));
...
ig.module("game.entities.plain-over")
    .requires("game.entities.plain", "game.entities.plain-over-but")
    .defines(function() {
        EntityPlainOver = EntityPlain.extend({
            ...
            init: function(b, c, d) {
                ig.global.wm ||
                    (this.parent(b, c, d),
                        this.oriStat(),
                        this.spawner(),
                        (this.starText = ig.game.star),
                        (this.nextLvl = 1500 * ig.game.lvl + 150 * ig.game.lvl),
                        (this.tweening = !0));
            },
            genQues: function() {},
            pauseGame: function() {},
            ...
            tweenF: function(b) {
                switch (b) {
                    ...
                    case "starText2":
                        ...
                        this.starText != ig.game.storage.get(ig.game.gameKey).star &&
                            (ig.game.star = ig.game.storage.get(ig.game.gameKey).star);
                        break;
                    case "textDown1":
                        this.tweening = !0;
                        this.tweener(
            ...
            update: function() {
                ig.global.wm ||
                    (this.parent(),
                        !0 == this.scoreTweening && this.soundLooper("score"),
                        this.runFrame("plane"),
                        this.runFrame("scarf"),
                        this.runFrame("fan"));
            },
            ...
            draw: function() {
                ...
                ig.global.wm ||
                    (this.bgIm.draw(0, 0),
                        this.cloudIm2.draw(48, 79 + this.cloud.offY),
                        this.cloudIm1.draw(427, 81 + this.cloud.offY),
                        this.cloudIm0.draw(439, 253 + this.cloud.offY),
                        this.drawer(
                            "game",
                            this.planeIm,
                            2,
                        ...
                        this.drawer(
                            ...
                            1,
                            this.scarf.frames[this.scarf.frame],
                            this.plane.x + this.scarf.x + this.offX,
                            this.plane.y + this.scarf.y + this.fan.offY[this.plane.frame],
                            this.scarf.sc,
                            this.scarf.sc,
                            !0
                        ...
                        this.drawer(
                            ...
                            1,
                            this.fan.frames[this.fan.frame],
                            this.plane.x + this.fan.x + this.offX,
                            this.plane.y + this.fan.y + this.fan.offY[this.plane.frame],
                            this.fan.sc,
                            this.fan.sc,
                            !0
                        ),
                        this.levelIm.draw(327 - this.levelIm.width / 2, 273 + this.offY - 60),
                        this.drawer(
                            "game",
                            this.starIm,
                            1,
                            ...
                            320 -
                            1.3 *
                            (this.ctx.measureText(Math.floor(this.starText)).width / 2) -
                            15 +
                            16,
                            168 + this.offY - 5 - 60,
                            0.9,
                        ...
                        this.textSet("game", 35, "white"),
                        (this.ctx.fillStyle = "#661408"),
                        this.textDraw(
                            "game",
                            0.9,
                            1,
                            ig.game.lvl,
                            326 - 0.9 * (this.ctx.measureText(ig.game.lvl).width / 2) + 2,
                            305 + this.offY - 60
                        ),
                        (this.ctx.fillStyle = "white"),
                        this.textDraw(
                            ...
                            1,
                            ig.game.lvl,
                            326 - 0.9 * (this.ctx.measureText(ig.game.lvl).width / 2),
                            303 + this.offY - 60
                        ),
                        (this.ctx.fillStyle = "#10527B"),
                        this.textDraw(
                            "game",
                            1.2,
                            1.3,
                            Math.floor(this.starText),
                            346 -
                            1.2 *
                            (this.ctx.measureText(Math.floor(this.starText)).width / 2) +
                            3,
                        ...
                        this.textDraw(
                            ...
                            Math.floor(this.starText),
                            346 -
                            1.2 * (this.ctx.measureText(Math.floor(this.starText)).width / 2),
                            164 + this.offY - 5 - 60
                        ),
                        (this.ctx.fillStyle = "#10527B"),
                        this.textDraw(
                            "game",
                            _STRINGS.Game.newLevel[3],
                            _STRINGS.Game.newLevel[4],
                            _STRINGS.Game.newLevel[0],
                            _STRINGS.Game.newLevel[1] -
                            1.1 *
                            (this.ctx.measureText(_STRINGS.Game.newLevel[0]).width / 2) +
                            3,
                            _STRINGS.Game.newLevel[2] + 3 + this.offY - 60
                        ),
                        (this.ctx.fillStyle = "white"),
                        this.textDraw(
                            "game",
                            ...
                            _STRINGS.Game.newLevel[0],
                            _STRINGS.Game.newLevel[1] -
                            1.1 * (this.ctx.measureText(_STRINGS.Game.newLevel[0]).width / 2),
                            _STRINGS.Game.newLevel[2] + this.offY - 60
                        ));
            },
        });
    });
ig.baked = !0;
ig.module("game.levels.over")
    .requires("impact.image", "game.entities.plain-over")
    .defines(function() {
        LevelOver = {
            entities: [{
...
ig.baked = !0;
ig.module("game.entities.plain-mission-but")
    .requires("game.entities.plain")
    .defines(function() {
        EntityPlainMissionBut = EntityPlain.extend({
            ...
            retryIm: new ig.AnimationSheet(
                "media/graphics/sprites/retry.png",
                403 / 3 - 1,
                85
            ),
            bookIm: new ig.AnimationSheet(
                "media/graphics/sprites/bookbut.png",
                460 / 3,
                88
            ),
            muteAni: {},
            ...
            oriStat: function() {
                ...
                switch (this.seq) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        this.pos.x = !1 == ig.game.afterFirstPlay ?
                            320 - (this.bookIm.width / 2) * this.scale.x + 55 :
                            320 - (this.bookIm.width / 2) * this.scale.x;
                        this.pos.y = 160;
                        this.animSheet = this.bookIm;
                        ig.game.oriNavi = "mission";
                        break;
                    case 6:
                        (this.pos.x = !1 == ig.game.afterFirstPlay ? -376 : 376),
                        (this.pos.y = 163),
                        (this.animSheet = this.retryIm);
                }
                this.addAnim("idle", 1, [0]);
                this.addAnim("select", 1, [1]);
                this.addAnim("grey", 1, [2]);
                ...
                this.size.y = this.animSheet.height - 30;
                this.offset.x = 15;
                this.offset.y = 15;
                this.oriY = this.pos.y;
                this.pos.y = -700;
            ...
            update: function() {
                ig.global.wm ||
                    (this.parent(),
                        ...
                        !0 == this.main.tweening ?
                        (this.pos.y =
                            4 == this.seq || 5 == this.seq || 6 == this.seq || 2 == this.seq ?
                            this.main.offY + this.oriY :
                            this.main.offUp + this.oriY) :
                        null != this.pointer &&
                        this.pointer.hoveringItem == this &&
...
ig.baked = !0;
ig.module("game.entities.plain-mission")
    .requires("game.entities.plain", "game.entities.plain-mission-but")
    .defines(function() {
        EntityPlainMission = EntityPlain.extend({
            ...
            init: function(b, c, d) {
                ig.global.wm ||
                    (this.parent(b, c, d),
                        ...
                        this.spawner(),
                        this.textSet("game", 35, "white"),
                        (_STRINGS.Game.nextlevelNumber[0] = this.nextLvl),
                        (_STRINGS.Game.nextlevelNumber[1] =
                            320 +
                            this.ctx.measureText(_STRINGS.Game.nextlevelMission[0]).width / 2),
                        (this.starText = ig.game.star),
            ...
            spawner: function() {
                ...
                for (var b = 0; 7 > b; b++)
                    ig.game.spawnEntity(EntityPlainMissionBut, -200, -200, {
                        main: this,
                        seq: b,
                    });
            },
            ...
            draw: function() {
                ...
                ig.global.wm ||
                    (this.textSet("game", 35, "white"),
                        ...
                        (this.ctx.fillStyle = "#242A2D"),
                        this.cloudIm2.draw(36, 109 + this.cloud.offY),
                        this.cloudIm1.draw(427, 60 + this.cloud.offY),
                        this.cloudIm0.draw(480, 250 + this.cloud.offY),
                        this.drawer(
                            "game",
                            this.starIm,
                            1,
                        ...
                        20 > ig.game.lvl ?
                        ((this.ctx.fillStyle = "#14325D"),
                            this.textDraw(
                                "game",
                                _STRINGS.Game.nextlevelNumber[3],
                                _STRINGS.Game.nextlevelNumber[4],
                                this.nextLvl,
                                _STRINGS.Game.nextlevelMission[1] +
                                (this.ctx.measureText(_STRINGS.Game.nextlevelMission[0])
                                    .width /
                                    2) *
                                _STRINGS.Game.nextlevelMission[3] -
                                this.ctx.measureText(this.nextLvl).width / 2,
                                135 + this.offY
                            ),
                            this.textLib(
                                "nextlevelMission",
                        ...
                        ((this.ctx.fillStyle = "#14325D"),
                            this.textLib("maxLvl", 0, this.offY)));
            },
        });
    });
ig.baked = !0;
ig.module("game.levels.mission")
    .requires("impact.image", "game.entities.plain-mission")
    .defines(function() {
        LevelMission = {
            entities: [{
...
ig.baked = !0;
ig.module("game.entities.plain-book-but")
    .requires("game.entities.plain")
    .defines(function() {
...
ig.baked = !0;
ig.module("game.entities.plain-book")
    .requires("game.entities.plain", "game.entities.plain-book-but")
    .defines(function() {
        EntityPlainBook = EntityPlain.extend({
            ...
            init: function(b, c, d) {
                ig.global.wm ||
                    (this.parent(b, c, d),
                        this.oriStat(),
                        this.spawner(),
                        (this.level = ig.game.lvl),
                        (this.score = ig.game.star),
                        (this.mission = ig.game.mission));
            },
            genQues: function() {},
            pauseGame: function() {},
            resumeGame: function() {},
            ...
            draw: function() {
                ...
                ig.global.wm ||
                    (this.bgIm.draw(0, 0),
                        this.bookIm.draw(18, 119 + this.book.offY),
                        this.textSet("game", 35, "white"),
                        (this.ctx.fillStyle = "#122149"),
                        this.textDraw(
                            "game",
                            _STRINGS.Game.logbook[3],
                            _STRINGS.Game.logbook[4],
                            _STRINGS.Game.logbook[0],
                            _STRINGS.Game.logbook[1] +
                            4 -
                            (this.ctx.measureText(_STRINGS.Game.logbook[0]).width / 2) *
                            _STRINGS.Game.logbook[3],
                            _STRINGS.Game.logbook[2] + 5 + this.title.offY
                        ),
                        (this.ctx.fillStyle = "white"),
                        this.textDraw(
                            "game",
                            ...
                            (this.ctx.measureText(_STRINGS.Game.logbook[0]).width / 2) *
                            _STRINGS.Game.logbook[3],
                            _STRINGS.Game.logbook[2] + this.title.offY
                        ),
                        this.wingLIm.draw(
                            302 -
                            (this.ctx.measureText(_STRINGS.Game.logbook[0]).width / 2) *
                        ...
                        this.textDraw(
                            "game",
                            _STRINGS.Game.pilotLevel[3],
                            _STRINGS.Game.pilotLevel[4],
                            _STRINGS.Game.pilotLevel[0],
                            _STRINGS.Game.pilotLevel[1],
                            _STRINGS.Game.pilotLevel[2] - 7 + this.book.line0
                        ),
                        this.textDraw(
                            "game",
                            _STRINGS.Game.score[3],
                            _STRINGS.Game.score[4],
                            _STRINGS.Game.score[0],
                            _STRINGS.Game.score[1],
                            _STRINGS.Game.score[2] - 7 + this.book.line1
                        ),
                        this.textDraw(
                            "game",
                            _STRINGS.Game.missions[3],
                            _STRINGS.Game.missions[4],
                            _STRINGS.Game.missions[0],
                            _STRINGS.Game.missions[1],
                            _STRINGS.Game.missions[2] - 7 + this.book.line2
                        ),
                        this.textDraw(
                            "game",
                            _STRINGS.Game.completed[3],
                            _STRINGS.Game.completed[4],
                            _STRINGS.Game.completed[0],
                            _STRINGS.Game.completed[1],
                            _STRINGS.Game.completed[2] - 7 + this.book.line2
                        ),
                        this.textDraw(
                            "game",
                            _STRINGS.Game.pilotLevel[3] + 0.2,
                            _STRINGS.Game.pilotLevel[4] + 0.2,
                            this.level,
                            277 -
                            this.ctx.measureText(this.level).width *
                            _STRINGS.Game.pilotLevel[3],
                            185 + this.book.line0
                        ),
                        this.textDraw(
                            ...
                            this.score,
                            277 -
                            this.ctx.measureText(this.score).width *
                            _STRINGS.Game.pilotLevel[3],
                            243 + this.book.line1
                        ),
                        this.textDraw(
                            ...
                            this.mission,
                            277 -
                            this.ctx.measureText(this.mission).width *
                            _STRINGS.Game.pilotLevel[3],
                            336 + this.book.line2
                        ),
                        this.drawer(
...
ig.baked = !0;
ig.module("game.levels.book")
    .requires("impact.image", "game.entities.plain-book")
    .defines(function() {
        LevelBook = {
            entities: [{
...
ig.baked = !0;
ig.module("game.entities.plain-shop-but")
    .requires("game.entities.plain")
    .defines(function() {
        EntityPlainShopBut = EntityPlain.extend({
            ...
            textColor: "white",
            leftIm: new ig.AnimationSheet(
                "media/graphics/sprites/arrow-l.png",
                194 / 3,
                69
            ),
            rightIm: new ig.AnimationSheet(
                "media/graphics/sprites/arrow-r.png",
                194 / 3,
                69
            ),
            backIm: new ig.AnimationSheet("media/graphics/sprites/back.png", 42, 55),
            buttonIm: new ig.AnimationSheet(
                "media/graphics/sprites/button.png",
                635 / 3,
                70
            ),
            muteAni: {},
            ...
            clicked: function() {
                this.sounder("click");
                if (!this.locked)
                    switch ((this.setScale(0.85, 0.85), this.seq)) {
                        case 0:
                        ...
                        case 2:
                            if (!0 == this.main.tweening) break;
                            if (ig.game.star < Number(this.main.prices[this.main.which]))
                                break;
            ...
            update: function() {
                ig.global.wm ||
                    (this.parent(),
                        2 == this.seq &&
                        (ig.game.star < Number(this.main.prices[this.main.which]) ?
                            ((this.textColor = "#4E515D"),
                        ...
                        !this.pointer.firstClick &&
                        (this.setScale(1, 1),
                            2 != this.seq && (this.currentAnim = this.anims.select)));
            },
            drawInit: function() {},
            ready: function() {
                this.pointer = ig.game.getEntitiesByType(EntityPointer)[0];
            ...
            draw: function() {
                ...
                !ig.global.wm &&
                    ...
                    ((this.ctx.fillStyle = this.textColor),
                        ...
                        this.textDraw(
                            "game",
                            _STRINGS.Game.notenough[3] * this.scale.x,
                            _STRINGS.Game.notenough[4] * this.scale.y,
                            _STRINGS.Game.notenough[0],
                            this.pos.x +
                            this.size.x / 2 -
                            (this.ctx.measureText(_STRINGS.Game.notenough[0]).width / 2) *
                            _STRINGS.Game.notenough[3] *
                            this.scale.x,
                            this.pos.y + this.size.y / 2 - 5
                        ) :
                        this.textDraw(
                            "game",
                            _STRINGS.Game.select[3] * this.scale.x,
                            _STRINGS.Game.select[4] * this.scale.y,
                            _STRINGS.Game.select[0],
                            this.pos.x +
                            this.size.x / 2 -
                            (this.ctx.measureText(_STRINGS.Game.select[0]).width / 2) *
                            _STRINGS.Game.select[3] *
                            this.scale.x,
                            this.pos.y + this.size.y / 2 - 5
                        ));
            },
...
ig.baked = !0;
ig.module("game.entities.plain-shop")
    .requires("game.entities.plain", "game.entities.plain-shop-but")
    .defines(function() {
        EntityPlainShop = EntityPlain.extend({
            ...
            spawner: function() {
                ...
                for (var b = 0; 4 > b; b++)
                    ig.game.spawnEntity(EntityPlainShopBut, -200, -200, {
                        main: this,
                        seq: b,
                    });
            },
                ...
                ig.global.wm ||
                    (this.bgIm.draw(0, 0),
                        ...
                        this.drawer(
                            ...
                            this.plane.offX +
                            320 -
                            1 * (this.ctx.measureText(this.prices[this.which]).width / 2) -
                            32 +
                            20,
                            100,
                            0.8,
                        ...
                        this.drawer("game", this.starIm, 1, 1, 0, 33, 30, 0.6, 0.6, !0),
                        this.textSet("game", 35, "white"),
                        this.textDraw(
                            "game",
                            1,
                            1.1,
                            this.prices[this.which],
                            this.plane.offX +
                            320 -
                            1 * (this.ctx.measureText(this.prices[this.which]).width / 2) +
                            20,
                        ...
                        this.textDraw(
                            ...
                            0.8,
                            ig.game.star,
                            60 - 0.8 * (this.ctx.measureText(ig.game.star).width / 2) + 20,
                            29
                        ),
                        this.which == ig.game.player &&
                        !1 == this.tweening &&
                        ((this.ctx.fillStyle = "#122149"),
                            this.ctx.fillRect(
                                320 -
                                (this.ctx.measureText(_STRINGS.Game.selected[0]).width / 2) *
                                _STRINGS.Game.selected[3] -
                                10,
                                321,
                                this.ctx.measureText(_STRINGS.Game.selected[0]).width *
                                _STRINGS.Game.selected[3] +
                                20,
                                30
                            ),
                            (this.ctx.fillStyle = "white"),
                            this.textLib("selected")),
                        this.drawer(
                            "game",
                            this["planeIm" + this.which],
                            1,
                            1,
                            0,
                            this.plane.offX + 320,
                            ...
                            this.plane.alp,
                            0,
                            -this["planeIm" + this.which].width / 2,
                            -this["planeIm" + this.which].height
                        ));
            },
        });
    });
ig.baked = !0;
ig.module("game.levels.shop")
    .requires("impact.image", "game.entities.plain-shop")
    .defines(function() {
        LevelShop = {
            entities: [{
...
ig.baked = !0;
ig.module("game.entities.plain-map-but")
    .requires("game.entities.plain")
    .defines(function() {
            ...
            draw: function() {
                ...
                !ig.global.wm &&
                    ...
                    ((this.ctx.fillStyle = this.textColor),
                        ...
                        this.textDraw(
                            "game",
                            _STRINGS.Game.selectMap[3] * this.scale.x,
                            _STRINGS.Game.selectMap[4] * this.scale.y,
                            _STRINGS.Game.selectMap[0],
                            this.pos.x +
                            this.size.x / 2 -
                            (this.ctx.measureText(_STRINGS.Game.selectMap[0]).width / 2) *
                            _STRINGS.Game.selectMap[3] *
                            this.scale.x,
                            this.pos.y + this.size.y / 2 - 5
                        ));
            },
...
ig.baked = !0;
ig.module("game.entities.plain-map")
    .requires("game.entities.plain", "game.entities.plain-map-but")
    .defines(function() {
        EntityPlainMap = EntityPlain.extend({
            ...
            spawner: function() {
                ...
                for (var b = 0; 4 > b; b++)
                    ig.game.spawnEntity(EntityPlainMapBut, -200, -200, {
                        main: this,
                        seq: b,
                    });
            },
            ...
            draw: function() {
                ...
                ig.global.wm ||
                    (this.bgIm.draw(0, 0),
                        this.drawer(
                            "game",
                            this["sceneIm" + this.which],
                            1,
                            1,
                            0,
                            this.scene.offX + 320 + 5,
                            374,
                            1,
                            1,
                            !1,
                            this.scene.alp,
                            0,
                            -this["sceneIm" + this.which].width / 2,
                            -this["sceneIm" + this.which].height
                        ),
                        this.drawer(
                            "game",
                            this.starIm,
                        ...
                        this.which == ig.game.map &&
                        !1 == this.tweening &&
                        ((this.ctx.fillStyle = "#122149"),
                            this.ctx.fillRect(
                                320 -
                                (this.ctx.measureText(_STRINGS.Game.selectedMap[0]).width / 2) *
                                _STRINGS.Game.selectedMap[3] -
                                10,
                                331,
                                this.ctx.measureText(_STRINGS.Game.selectedMap[0]).width *
                                _STRINGS.Game.selectedMap[3] +
                                20,
                                35
                            ),
                            (this.ctx.fillStyle = "white"),
                            this.textLib("selectedMap")));
            },
        });
    });
ig.baked = !0;
ig.module("game.levels.map")
    .requires("impact.image", "game.entities.plain-map")
    .defines(function() {
        LevelMap = {
            entities: [{
                type: "EntityPlainMap",
...
ig.baked = !0;
ig.module("game.entities.plain-sky")
    .requires("game.entities.plain")
    .defines(function() {
                ...
                if (
                    ...
                    for (var b = 0; 3 > b; b++)
                        ...
                        ((this["x" + b] += this.speed),
                            b == this.targL &&
                            -50 < this["x" + b] &&
                            ((this["x" + ((b + 2) % 3)] = this["x" + b] - this.w),
                                (this.targL = (this.targL + 2) % 3))) :
                        (b == this.targL &&
                            this["x" + ((b + 2) % 3)] + this.w < this.main.w + 50 &&
                            ((this["x" + b] = this["x" + ((b + 2) % 3)] + this.w),
                                (this.targL = (this.targL + 1) % 3)),
                            (this["x" + b] -= this.speed));
            },
            drawInit: function() {},
            draw: function() {
                ...
                this.ctx.fillRect(
                    ...
                    this.bgIm0.height,
                    ig.system.width,
                    ig.system.height - this.bgIm0.height
                );
                ...
                if (!ig.global.wm) {
                    for (var b = 0; 3 > b; b++)
                        this["x" + b] > -this.w &&
                        this["x" + b] + this.w < this.main.w + this.w &&
                        this.drawer(
                            "game",
                            this["bgIm" + this.main.which],
                            3,
                            1,
                            b,
                            this["x" + b],
...
ig.baked = !0;
ig.module("game.entities.plain-ground")
    .requires("game.entities.plain")
    .defines(function() {
        EntityPlainGround = EntityPlain.extend({
            ...
            showRing: !1,
            Ypos: [
                147, 140.0112, 137.25, 135.5028, 134.3328, 134, 147.20550400000002,
                161.00297600000002, 173.76918400000005, 187.09990400000004,
                200.95270400000004, 212.29078400000006, 224.91430400000007,
                237.2973760000001, 250.14678400000008, 260.6487040000001,
                272.3245760000001, 283.7600000000001, 294.9549760000001,
                305.27177600000016, 315.3755840000001, 326.48777600000017,
                336.1389760000001, 346.16000000000014, 355.3719040000002,
                365.4807040000002, 373.69878400000016, 383.3133760000002,
                391.63337600000017, 400.73878400000024, 408.12070400000016,
                416.7319040000002, 423.70198400000015, 431.3751040000002,
                438.80777600000016, 446.4155840000002, 452.5495040000002,
                459.6631040000002, 465.3851840000002, 471.6439040000002,
                478.0087040000002, 483.1067840000002, 488.65830400000016,
                494.27430400000014, 498.74838400000016, 503.59270400000014,
                508.1965760000001, 512.8091840000002, 516.4471040000001,
                520.5655040000001, 524.0000000000001, 527.415776, 530.4109760000001,
                533.3600000000001, 536.0685760000001, 538.5367040000001, 540.514784,
                542.5303039999999, 544.402304, 545.756384, 547.134176,
                548.1325760000001, 549.001184, 549.519104, 549.8935039999999, 550,
            ],
            startY: [100, 100, 100, 100],
            hitSize: [
                0.01, 0.04, 0.07, 0.1, 0.12, 0.14, 0.18, 0.15, 0.1, 0.06, 0.01, -0.02,
                -0.05, 0.01, -0.02, -0.05, -0.1, 0.01,
            ],
            ...
            oilSc: [
                1, 1.1009777777777778, 1.1527777777777777, 1.1983944444444445,
                1.2408000000000001, 1.2799944444444444, 1.3139500000000002,
                1.3469111111111112, 1.3766611111111113, 1.401727777777778,
                1.4252444444444445, 1.4444444444444446, 1.461727777777778, 1.4758,
                1.4866611111111112, 1.4939500000000001, 1.4985777777777778, 1.5,
                1.3442666666666665, 1.1792666666666665, 1.041666666666666,
                0.9048166666666662, 0.7775999999999994, 0.6666666666666661,
                0.564266666666666, 0.47039999999999926, 0.37499999999999933,
                0.29481666666666584, 0.2281499999999994, 0.16334999999999944,
                0.11759999999999948, 0.07259999999999955, 0.041666666666666075,
                0.018149999999999666, 0.004816666666666691,
            ],
            ...
            treeWidth2: [103, 80, 86, 145, 80, 78, 56, 47, 85],
            ...
            oriStat: function() {
                ...
                this.base = {
                    x: 240,
                    w: Math.floor(
                        this["rockIm" + this.main.which].width /
                        this.rockVault[this.main.which]
                    ),
                    y: 130,
                    sc: 1,
                    oriSc: 0.9,
                ...
                for (var b = 0; 12 > b; b++)
                    for (var c = 0; 6 > c; c++)
                        this.rocks.unshift({
                            ...
                            alp: 0,
                            show: !0,
                            which: 3 == Math.floor(10 * Math.random()) ?
                                Math.floor(Math.random() * this.rockVault[this.main.which]) : Math.floor(Math.random() * this.smallRock[this.main.which]),
                ...
                switch (ig.game.what) {
                    case "follow":
                        ...
                        break;
                    case "tree":
                        this.spawnKnockers("tree", 10 + Math.floor(ig.game.lvl / 5));
                        this.spawnKnockers("star", 3);
                        break;
                    case "ufo":
                        this.main.heart = 10;
                    ...
                    case "star":
                        ...
                        break;
                    case "balloon":
                        this.spawnKnockers("balloon", 10 + Math.floor(ig.game.lvl / 5));
                        this.spawnKnockers("star", 3);
                        break;
                    case "heart":
                    ...
                    case "oil":
                        ...
                        break;
                    case "ring":
                        (this.main.howmany = 60 + 5 * Math.floor(ig.game.lvl / 5)),
                        this.gui.tweenF("arrowFlash0"),
                            this.spawnKnockers("ring", 2);
                }
                this.indexSwap();
            },
                ...
                switch (b) {
                    ...
                    case "oil":
                        for (var d = 0; d < this.amount; d++)
                            (this.tempX = -400 +
                                this.main.world.x +
                                Math.floor(Math.random() * (this.main.w + 800))),
                            (this.posX = 0),
                            (this.posX =
                                0 > this.tempX ?
                                3 * this.sky.w + this.tempX :
                                this.tempX > 3 * this.sky.w ?
                                this.tempX % (3 * this.sky.w) :
                                this.tempX),
                            (this.tempMoveX =
                                "ufo" == b.what ?
                            ...
                            (this.tempWhich =
                                "tree" == b ?
                                3 == Math.floor(10 * Math.random()) ?
                                Math.floor(
                                    Math.random() * this.treeVault[this.main.which]
                                ) :
                                Math.floor(
                                    Math.random() * this.bigTree[this.main.which]
                                ) :
                                Math.floor(3 * Math.random())),
                            this.rocks.push({
                                seq: d,
                                hitRectW: "tree" == b ?
                                    this[b + "Width" + this.main.which][this.tempWhich] : this[b + "Im"].width / 3,
                                hitRectH: "tree" == b ?
                                    this[b + "Tall" + this.main.which][this.tempWhich] : this[b + "Im"].height,
                                what: b,
                                alp: 0,
                                show: !0,
                        ...
                        break;
                    case "heart":
                        for (d = 0; d < this.amount; d++)
                            (this.tempSide = Math.floor(2 * Math.random())),
                            0 == this.tempSide ?
                            (this.tempX = this.itemPos + 10) :
                            1 == this.tempSide ?
                            (this.tempX = this.itemPos - 20) :
                            2 == this.tempSide && (this.tempX = this.itemPos),
                            (this.itemPos = this.tempX = -400 +
                                this.main.world.x +
                                Math.floor(Math.random() * (this.main.w + 800))),
                            (this.posX = 0),
                            (this.posX =
                    ...
                    case "star":
                        for (d = 0; d < this.amount; d++)
                            ...
                            this.rocks.push({
                                ...
                                screenX: 0,
                                x0: 320,
                                y0: this.startY[this.main.which] + 80,
                                x1: 320,
                                y1: 190,
                                x2: 640,
                                y2: 550,
            ...
            reGenItem: function(b) {
                ...
                ((b.start = !0),
                    ...
                    (b.scSpeed = 0.01),
                    "ufo" == b.what ?
                    (b.moveX = -3 + 6 * Math.random()) :
                    "balloon" == b.what ?
                    (b.moveX = -1 + 2 * Math.random()) :
                    "ship" == b.what && (b.moveX = -3 + 3 * Math.random()),
                    "ring" == b.what &&
                    ((b.which = 0),
                        "ring" == ig.game.what && this.main.total++,
                        (this.tempSide = Math.floor(2 * Math.random())),
                        0 == this.tempSide ?
                        (this.tempX = this.itemPos + 20) :
                        1 == this.tempSide ?
                    ...
                    (b.which =
                        3 == Math.floor(10 * Math.random()) ?
                        Math.floor(Math.random() * this.rockVault[this.main.which]) :
                    ...
                    ("tree" == b.what ||
                        ...
                        (this.tempX = -400 +
                            ...
                            Math.floor(Math.random() * (this.main.w + 800))) :
                        "star" == b.what ?
                        ("star" == ig.game.what && this.main.total++,
                            !0 == b.straight ?
                            ((this.tempSide = Math.floor(2 * Math.random())),
                                0 == this.tempSide ?
                                (this.tempX = this.itemPos + 20) :
                        ...
                        ((this.tempSide = Math.floor(2 * Math.random())),
                            0 == this.tempSide ?
                            (this.tempX = this.itemPos + 20) :
                            1 == this.tempSide && (this.tempX = this.itemPos - 20),
                            (this.itemPos = this.tempX)),
                        (b.x =
                            0 > this.tempX ?
                            3 * this.sky.w + this.tempX :
            ...
            offsetWorldPos: function(b) {
                b.screenX =
                    this.main.world.x > 3 * this.sky.w - this.main.w ?
                    b.x < this.main.w ?
                    b.x + 3 * this.sky.w - this.main.world.x :
                    b.x - this.main.world.x :
                    0 > this.main.world.x ?
                    b.x > 3 * this.sky.w - this.main.w ?
                    b.x - 3 * this.sky.w - this.main.world.x :
                    b.x - this.main.world.x :
                    b.x - this.main.world.x;
            },
            renderPosition: function(b) {
                ...
                b.finalX =
                    (1 - b.percent) * (1 - b.percent) * b.x0 +
                    2 * (1 - b.percent) * b.percent * b.x1 +
                    b.percent * b.percent * b.x2;
                this.topPercent = 0.2;
                "ring" == b.what &&
                    100 < b.finalX &&
                    540 > b.finalX &&
                ...
                "star" == b.what &&
                    ...
                    540 > b.finalX &&
                    (this.showRing = !0);
                b.percent < this.topPercent &&
                    (b.finalY =
                        (1 - this.topPercent) * (1 - this.topPercent) * b.y0 +
                        2 * (1 - this.topPercent) * b.percent * b.y1 +
                        this.topPercent * b.percent * b.y2);
                b.finalY =
                    (1 - b.percent) * (1 - b.percent) * b.y0 +
                    2 * (1 - b.percent) * b.percent * b.y1 +
                    b.percent * b.percent * b.y2;
                "ring" == b.what && (b.finalY *= 0.9);
            },
            fadeAlpha: function(b) {
                0.9 < b.percent ?
                    0 < b.alp && ((b.alp -= 0.08), 0 > b.alp && (b.alp = 0)) :
                    1 > b.alp && ((b.alp += 0.09), 1 < b.alp && (b.alp = 1));
            },
            poofInScale: function(b) {
                b.sc = (0.2 + b.finalY / this.main.h) * b.oriSc;
                "star" != b.what &&
                    ("ring" == b.what ?
                        (b.sc = 0.2 + b.percent * (b.oriSc - 0.2)) :
                        "ufo" == b.what ?
                        0.12 > b.percent &&
                        (b.sc = (b.percent / 0.12) * (b.sc - 0.2) + 0.2) :
                        "ship" == b.what ?
                        0.2 > b.percent && (b.sc *= b.percent / 0.2) :
                        "tree" == b.what ?
                        0.12 > b.percent && (b.sc *= b.percent / 0.12) :
                        0.12 > b.percent &&
                        (b.sc = (b.percent / 0.12) * (b.sc - 0.2) + 0.2));
            },
            processHitItem: function(b) {
                if (
                    ...
                    ((this.hitPercent =
                            "oil" == b.what ?
                            this.plane.plane.percent + 0.05 :
                            "ring" == b.what ?
                            this.plane.plane.percent + 0.15 :
                            this.plane.plane.percent),
                        "frame" == b.what &&
                        (this.plane.frame.which = this.plane.abCheck(b) ? 0 : 1),
                        b.percent < this.hitPercent &&
                        b.percent > this.hitPercent - 0.1 &&
                        this.plane.abCheck(b) &&
                        !1 == b.hitted)
                )
                    switch (((this.plane.plane.hitIndex = 0), (b.hitted = !0), b.what)) {
                        case "tree":
                        case "balloon":
                        case "ufo":
                        case "ship":
                            ...
                            "oil" != ig.game.what &&
                                ...
                                ((this.main.heart -= 1),
                                    0 >= this.main.heart &&
                                    ((this.main.preGameOver = !0),
                                        this.main.gameOverTimer.reset(),
                                        this.main.gameTimer.pause()));
                        ...
                        case "oil":
                            this.sounder("vacuum"),
                                this.gui.tweenF("movePlane"),
                                this.puffer.reGen(b, "oil");
                    }
            },
            hittedActions: function(b) {
                !0 == b.hitted &&
                    ("oil" == b.what ?
                        ((b.hitIndex += 3),
                            b.hitIndex < this.oilSc.length ?
                            (b.sc *= this.oilSc[b.hitIndex]) :
                            (b.show = !1)) :
                        "ring" == b.what ?
                        (b.hitIndex < this.hitSize.length - 12 && (b.hitIndex += 1),
                            (b.sc += 1.2 * this.hitSize[b.hitIndex]),
                            10 < b.hitIndex && ((b.alp -= 0.1), 0 > b.alp && (b.alp = 0))) :
                        ((b.hitIndex += 1),
                            b.hitIndex < this.hitSize.length &&
                            (b.sc += this.hitSize[b.hitIndex])));
            },
            indexSwap: function() {
            ...
            behaviors: function(b) {
                switch (b.what) {
                    ...
                    case "ship":
                        ...
                        b.x =
                            0 > this.ufoX ?
                            3 * this.sky.w + this.ufoX :
                            this.ufoX > 3 * this.sky.w ?
                            this.ufoX % (3 * this.sky.w) :
                            this.ufoX;
                        break;
                    case "leader":
                        ...
                        0 > b.x ?
                            (b.x += 3 * this.sky.w) :
                            b.x > 3 * this.sky.w && (b.x %= 3 * this.sky.w);
                        b.rot =
                            0 == b.which ?
                            -30 < b.rot ?
                            b.rot - 1 :
                    ...
                    case "frame":
                        if (b.moveCount.delta() > b.moveTime)
                            if ((b.moveCount.reset(), 1 == Math.floor(6 * Math.random()))) {
                                b.moveTime = 3;
                                for (var c = (b.moveX = 0); 3 > c; c++)
                                    this.plane["plane" + c].which = 1;
                            } else if (
                            ((b.moveTime = 3 + 3 * Math.random()),
                                (b.moveX = -2 + 4 * Math.random()),
                                0 > b.moveX)
                        )
                    ...
                    case "ufo":
                        !0 == b.lightOn ?
                            1 > b.lightAlp ?
                            ((b.lightAlp += 0.014), 1 < b.lightAlp && (b.lightAlp = 1)) :
                            (b.lightOn = !1) :
                            0 < b.lightAlp ?
                            ((b.lightAlp -= 0.014), 0 > b.lightAlp && (b.lightAlp = 0)) :
                            (b.lightOn = !0),
                            (this.ufoX = b.x + b.moveX),
                            (b.x =
                                0 > this.ufoX ?
            ...
            update: function() {
                if (
                    ...
                    (this.parent(),
                        (this.showRing = !1),
                        this.runFrame("scarf"),
                        !0 == this.boom.show && this.runFrame("boom"),
                        !0 != this.main.gameOver)
                )
                    if (!1 == this.main.gameStart)
                        for (var b = 0; b < this.rocks.length; b++) {
                            if (
                                ("rock" == this.rocks[b].what &&
                                    (this.rocks[b].percent +=
                                        0.01 * this.main.zSpeed * ig.system.tick),
                                    "player" == this.rocks[b].what || "rock" == this.rocks[b].what)
                            )
                                1 < this.rocks[b].percent && this.reGenItem(this.rocks[b]),
                                this.offsetWorldPos(this.rocks[b]),
                                -100 < this.rocks[b].screenX &&
                                740 > this.rocks[b].screenX + this.base.w &&
                                (this.renderPosition(this.rocks[b]),
                                    this.fadeAlpha(this.rocks[b]),
                                    this.poofInScale(this.rocks[b]));
                        }
                else if (!1 == this.main.gamePaused)
                    for (b = 0; b < this.rocks.length; b++)
                        "player" != this.rocks[b].what &&
                        "frame" != this.rocks[b].what &&
                        "leader" != this.rocks[b].what &&
                        (this.rocks[b].percent +=
                            0.01 * this.main.zSpeed * ig.system.tick),
                        1 < this.rocks[b].percent && this.reGenItem(this.rocks[b]),
                        this.offsetWorldPos(this.rocks[b]),
                        -100 < this.rocks[b].screenX &&
                        740 > this.rocks[b].screenX + this.base.w &&
                        (this.behaviors(this.rocks[b]),
                            this.renderPosition(this.rocks[b]),
                            this.fadeAlpha(this.rocks[b]),
                            this.poofInScale(this.rocks[b]),
                            this.processHitItem(this.rocks[b]),
                            this.hittedActions(this.rocks[b]));
            },
            drawInit: function() {},
            ready: function() {
                this.parent();
                this.oriStat(); -
                1 < _STRINGS.Game[ig.game.what + "1"][0].indexOf("$") &&
                    (_STRINGS.Game[ig.game.what + "1"][0] =
                        _STRINGS.Game[ig.game.what + "1"][0].slice(
                            0,
                            _STRINGS.Game[ig.game.what + "1"][0].indexOf("$")
                        ) +
                        this.main.howmany +
                        _STRINGS.Game[ig.game.what + "1"][0].slice(
                            _STRINGS.Game[ig.game.what + "1"][0].indexOf("$") + 1
                        )); -
                1 < _STRINGS.Game[ig.game.what + "2"][0].indexOf("$") &&
                    (_STRINGS.Game[ig.game.what + "2"][0] =
                        _STRINGS.Game[ig.game.what + "2"][0].slice(
                            0,
                            _STRINGS.Game[ig.game.what + "2"][0].indexOf("$")
                        ) +
                        this.main.howmany +
                        _STRINGS.Game[ig.game.what + "2"][0].slice(
                            _STRINGS.Game[ig.game.what + "2"][0].indexOf("$") + 1
                        ));
            },
            draw: function() {
                this.parent();
                if (!ig.global.wm) {
                    this.drawer(
                        "game",
                        this["shadowIm" + ig.game.player],
                        1,
                        1,
                        0,
                        320,
                        this.plane.plane.finalY +
                        130 -
                        Math.abs(0.2 * this.plane.plane.rot) -
                        this["planeIm" + ig.game.player].height / 2,
                        0.87,
                        0.6,
                        !0,
                        "oil" == ig.game.what ? 0.2 : 0.9,
                        this.plane.plane.rot
                    );
                    for (var b = 0; b < this.rocks.length; b++) {
                        if (
                            !0 == this.rocks[b].start &&
                            !0 == this.rocks[b].show &&
                            -100 < this.rocks[b].screenX &&
                            740 > this.rocks[b].screenX + this.base.w &&
                            -200 < this.rocks[b].finalX &&
                            840 > this.rocks[b].finalX + this.base.w
                        )
                            switch (this.rocks[b].what) {
                                case "balloon":
                                case "ufo":
                                case "ship":
                                    "ufo" == this.rocks[b].what &&
                                        this.drawer(
                                            "game",
                                            this.lightIm,
                                            1,
                                            ...
                                            0,
                                            this.rocks[b].finalX,
                                            this.rocks[b].finalY + 40,
                                            this.rocks[b].sc,
                                            this.rocks[b].sc,
                                            !1,
                                            this.rocks[b].lightAlp * this.rocks[b].alp,
                                            0,
                                            (-this.lightIm.width / 2) * this.rocks[b].sc,
                                            -this.lightIm.height * this.rocks[b].sc
                                        );
                                    this.drawer(
                                        "game",
                                        this[this.rocks[b].what + "Im"],
                                        3,
                                        1,
                                        this.rocks[b].which,
                                        this.rocks[b].finalX,
                                        ...
                                        this.rocks[b].alp,
                                        0,
                                        (-this[this.rocks[b].what + "Im"].width / 2 / 3) *
                                        this.rocks[b].sc,
                                        -this[this.rocks[b].what + "Im"].height * this.rocks[b].sc
                                    );
                                    break;
                                case "rock":
                                    this.drawer(
                                        "game",
                                        this["rockIm" + this.main.which],
                                        this.rockVault[this.main.which],
                                        1,
                                        this.rocks[b].which,
                                        this.rocks[b].finalX,
                                        ...
                                        (-this["rockIm" + this.main.which].width /
                                            ...
                                            this.rockVault[this.main.which]) *
                                        this.rocks[b].sc,
                                        -this["rockIm" + this.main.which].height * this.rocks[b].sc
                                    );
                                    break;
                                case "tree":
                                    this.drawer(
                                        "game",
                                        this["treeIm" + this.main.which],
                                        ...
                                        this.rocks[b].alp,
                                        0,
                                        (-this["treeIm" + this.main.which].width /
                                            2 /
                                            this.treeVault[this.main.which]) *
                                        this.rocks[b].sc,
                                        -this["treeIm" + this.main.which].height * this.rocks[b].sc
                                    );
                                    break;
                                case "heart":
                                    this.drawer(
                                        ...
                                        this.rocks[b].alp,
                                        0,
                                        (-this.heartIm.width / 2) * this.rocks[b].sc,
                                        -this.heartIm.height * this.rocks[b].sc
                                    );
                                    break;
                                case "star":
                                    this.drawer(
                                        ...
                                        0,
                                        this.rocks[b].finalX,
                                        this.rocks[b].finalY - 5,
                                        this.rocks[b].sc,
                                        this.rocks[b].sc,
                                        !1,
                                        this.rocks[b].alp,
                                        0,
                                        (-this.starIm.width / 2) * this.rocks[b].sc,
                                        -this.starIm.height * this.rocks[b].sc
                                    );
                                    break;
                                case "leader":
                                    this.drawer(
                                        "game",
                                        this["planeIm" + this.rocks[b].num],
                                        3,
                                        1,
                                        this.rocks[b].which,
                                        this.rocks[b].finalX,
                                ...
                                case "oil":
                                    this.drawer(
                                        ...
                                        this.rocks[b].alp,
                                        0,
                                        (-this.oilIm.width / 2) * this.rocks[b].sc,
                                        -(this.oilIm.height - 5) * this.rocks[b].sc
                                    );
                                    break;
                                case "ring":
                                    this.drawer(
                        ...
                        "player" == this.rocks[b].what &&
                            (!0 == this.puffer.show && this.puffer.drawPuff(),
                                "oil" == ig.game.what &&
                                this.drawer(
                                    "game",
                                    this.targetIm,
                                ...
                                this.drawer(
                                    "game",
                                    this["planeIm" + ig.game.player],
                                    3,
                                    1,
                                    this.main.frame,
                                    320 + this.rocks[b].rot,
                                    Math.abs(0.2 * this.rocks[b].rot) +
                                    this.rocks[b].fly +
                                    this.rocks[b].finalY -
                                    this["planeIm" + ig.game.player].height / 2 +
                                    this.plane.plane.flyOffY,
                                    this.rocks[b].finalSc,
                                    this.rocks[b].finalSc,
                                    !0,
                                    1,
                                    this.rocks[b].rot,
                                    0,
                                    this.plane.scarfY[ig.game.player]
                                ),
                                this.drawer(
                                    "game",
                                    this.scarfIm,
                                    ...
                                    this.scarf.frames[this.scarf.frame],
                                    this.scarf.x +
                                    this.plane.scarfX[ig.game.player] +
                                    this.rocks[b].rot,
                                    this.rocks[b].finalY -
                                    this.scarf.y +
                                    Math.abs(0.2 * this.rocks[b].rot) +
                                ...
                                this.drawer(
                                    ...
                                    4,
                                    2,
                                    this.boom.frames[this.boom.frame],
                                    this.boom.x,
                                    this.boom.y,
                                    1,
                                    1,
                    ...
                    null != this.plane.frame &&
                        this.drawer(
                            ...
                            2,
                            1,
                            this.plane.frame.which,
                            this.plane.frame.finalX,
                            this.plane.frame.finalY + 80,
                            this.plane.frame.sc,
                            this.plane.frame.sc,
                            !0,
                            1,
                            0,
                            0,
                            -this.frameIm.height * this.plane.frame.sc
                        );
                }
            },
        });
...
ig.baked = !0;
ig.module("game.entities.plain-tree")
    .requires("game.entities.plain")
    .defines(function() {
        EntityPlainTree = EntityPlain.extend({
            ...
            spawnTrees: function() {
                for (var b = 0; 15 > b; b++) {
                    var c =
                        3 == Math.floor(10 * Math.random()) ?
                        Math.floor(Math.random() * this.treeVault[this.main.which]) :
...
ig.baked = !0;
ig.module("game.entities.plain-plane")
    .requires("game.entities.plain")
    .defines(function() {
        EntityPlainPlane = EntityPlain.extend({
            ...
            oil: [],
            rotAngles: [
                0, 6.237000000000001, 9.333, 12.213000000000003, 14.448000000000004,
                16.932000000000006, 19.07966666666667, 20.814666666666675,
                22.698666666666675, 24.103666666666676, 25.514666666666674,
                26.798666666666673, 27.703666666666674, 28.548000000000005,
                29.232000000000006, 29.637000000000008, 29.91466666666667, 30,
            ],
            rotSpeed: 30,
            rotAngle: 45,
            iniSpeed: 2,
            hitSize: [
                0.02, 0.04, 0.07, 0.1, 0.12, 0.14, 0.18, 0.2, 0.18, 0.15, 0.1, 0.06,
                0.01, -0.02, -0.05, -0.1, 0.01, 0.06, 0.01, -0.02, -0.05, -0.1,
            ],
            init: function(b, c, d) {
                ig.global.wm || (this.parent(b, c, d), this.oriStat());
            },
            ...
            abCheck: function(b) {
                ...
                j = 320 - ((this.plane.hitRectW - c) / 2) * this.plane.fixSc;
                n = this.plane.finalY;
            ...
            update: function() {
                if (
                    !ig.global.wm &&
                    (this.parent(),
                        !0 == this.tweening && this.oil.push(this.base.sc),
                        !0 == this.plane.hitted &&
                        ((this.plane.hitIndex += 1),
                            (this.plane.finalSc =
                                this.plane.hitIndex < this.hitSize.length ?
                                this.plane.fixSc + 0.8 * this.hitSize[this.plane.hitIndex] :
                                this.plane.fixSc)),
                        !0 == ig.input.state("right") ||
                        !0 == ig.input.state("left") ||
                        ig.ua.mobile)
                ) {
                    switch (this.plane.turning) {
                        case "left":
                            ...
                            for (var b = 0; b < this.tweens.length; b++)
                                -
                                1 < this.tweens[b].seq.indexOf("swift") &&
                                this.tweens[b].stop();
                            this.tweening = "left";
                            this.tweener(
                                "plane", {
                        ...
                        case "right":
                            ...
                            for (b = 0; b < this.tweens.length; b++)
                                -
                                1 < this.tweens[b].seq.indexOf("swift") &&
                                this.tweens[b].stop();
                            this.tweening = "right";
                        ...
                        case "middle":
                            ...
                            for (b = 0; b < this.tweens.length; b++)
                                -
                                1 < this.tweens[b].targ.indexOf("plane") &&
                                -1 == this.tweens[b].seq.indexOf("fly") &&
                                this.tweens[b].stop();
...
ig.baked = !0;
ig.module("game.entities.plain-puffer")
    .requires("game.entities.plain")
    .defines(function() {
        EntityPlainPuffer = EntityPlain.extend({
            ...
            reGen: function(b, c) {
                this.which = c;
                for (var d = 0; 5 > d; d++)
                    (this.puff[d].x = b.finalX),
                    (this.puff[d].y = 420),
                    (this.puff[d].progress = 0),
                    (this.puff[d].y = b.finalY),
                    (this.puff[d].rot = Math.floor(360 * Math.random())),
                    (this.puff[d].alp = 0),
                    (this.puff[d].sc = 0),
                    (this.puff[d].speedX = 20 * (d / 5) - 10 + 4 * Math.random()),
                    (this.puff[d].speedY = -30 + 15 * Math.random()),
                    (this.puff[d].lastX = 0),
                    (this.puff[d].lastY = 0),
                    (this.puff[d].oriSc = 0.3 + 0.4 * Math.random()),
                    (this.show = !0);
            },
            spawner: function() {
                for (var b = 0; 5 > b; b++)
            ...
            update: function() {
                if (!ig.global.wm && (this.parent(), !0 == this.show))
                    for (var b = (this.count = 0); b < this.puff.length; b++)
                        (this.puff[b].speedX *= 1.01),
                        (this.puff[b].speedY += 1.05),
                        (this.puff[b].x += this.puff[b].speedX),
                        (this.puff[b].y += this.puff[b].speedY),
                        (this.puff[b].rot += 5),
                        (this.puff[b].progress += 1),
                        1 > this.puff[b].sc &&
                        (this.puff[b].sc += 0.1 + 0.01 * this.puff[b].sc),
                        25 < this.puff[b].progress ?
                        ((this.puff[b].alp -= 0.1),
                            (this.puff[b].sc -= 0.1 + 0.01 * this.puff[b].sc),
                            0 > this.puff[b].sc && (this.puff[b].sc = 0)) :
                        (this.puff[b].alp += 0.1),
                        30 < this.puff[b].progress &&
                        ((this.puff[b].show = !1), (this.count += 1)),
                        this.count == this.puff.length && (this.show = !1);
            },
            drawPuff: function() {
                for (var b = 0; b < this.puff.length; b++)
                    0 < this.puff[b].alp &&
                    this.drawer(
                        "game",
                        this[this.which + "PuffIm"],
                        1,
                        1,
                        0,
                        this.puff[b].x,
                        this.puff[b].y,
                        this.puff[b].sc * this.puff[b].oriSc,
                        this.puff[b].sc * this.puff[b].oriSc,
                        !0,
                        this.puff[b].alp,
                        this.puff[b].rot
    ...
    .defines(function() {
        EntityPlainGui = EntityPlain.extend({
            ...
            tweenF: function(b) {
                switch (b) {
                    ...
                    case "movePlane":
                        ...
                        this.main.collect += 1;
                        !1 == this.main.preGameOver &&
                            this.main.collect >= this.main.howmany &&
                            ((this.main.preGameOver = !0),
                                this.main.gameOverTimer.reset(),
                                this.main.gameTimer.pause());
                        for (b = 0; b < this.sky.tweens.length; b++)
                            -
                            1 < this.sky.tweens[b].seq.indexOf("movePlane2") &&
                            this.sky.tweens[b].stop();
                        this.tweener(
                            "this", {
                    ...
                    case "gameOver1":
                        "fail" == this.overText ?
                            ((this.fail = !0), this.tweenF("fail")) :
                            ((this.goodJob = !0), this.tweenF("goodJob"));
                        this.tweener(
                            "overBoard", {
                                offY: -25,
                            },
                    ...
                    case "offBoard1":
                        ...
                        break;
                    case "offBoard2":
                        ig.game.plusScore > ig.game.nextLvl && 20 > ig.game.lvl ?
                            ((ig.game.lvl += 1),
                                (ig.game.nextLvl = 2500 * ig.game.lvl + 150 * ig.game.lvl),
                                ig.game.storage.set(ig.game.gameKey, {
                            ...
                            (ig.game.storage.set(ig.game.gameKey, {
                                ...
                                ig.game.director.jumpTo(LevelMission)),
                            this.setScore(ig.game.gameKey);
                }
            },
            update: function() {
                ig.global.wm ||
                    (this.parent(),
                        !0 == this.tweening && this.soundLooper("score"),
                        !0 == this.main.gameOver &&
                        !1 == this.gameOverSpeech &&
                        ((this.gameOverSpeech = !0), this.tweenF("gameOver0")));
            },
            countScore: function() {
                this.finalScore = Math.floor(ig.game.storage.get(ig.game.gameKey).star);
                switch (ig.game.what) {
                    case "ufo":
                    case "ship":
                    case "balloon":
                        60 > this.main.gameTimer.delta() ?
                            ((this.overText = "fail"),
                                (this.finalText = ig.game.storage.get(ig.game.gameKey).star)) :
                            ((this.overText = "complete"),
                                (this.score1 = 10 * this.main.heart),
                                (this.score2 = 5 * this.main.star),
                                (this.score3 = 500),
                                (this.finalScore =
                                    ig.game.storage.get(ig.game.gameKey).star +
                                    this.score1 +
                                    this.score2 +
                                    this.score3));
                        break;
                    case "oil":
                        this.main.collect < this.main.howmany ?
                            ((this.overText = "fail"),
                                (this.finalText = ig.game.storage.get(ig.game.gameKey).star)) :
                            ((this.overText = "complete"),
                                (this.score1 = Math.floor(
                                    1e3 * ((60 - this.main.gameTimer.delta()) / 60)
                                )),
                                (this.score2 = 10 * this.main.star),
                                (this.score3 = 400),
                                (this.finalScore =
                                    ig.game.storage.get(ig.game.gameKey).star +
                                    this.score1 +
                        ...
                        break;
                    case "ring":
                        this.main.ring < this.main.howmany ?
                            ((this.overText = "fail"),
                                (this.finalText = ig.game.storage.get(ig.game.gameKey).star)) :
                            ((this.overText = "complete"),
                                (this.score1 = 800 * (this.main.ring / this.main.total)),
                                (this.score3 = 200),
                                (this.finalScore =
                                    ig.game.storage.get(ig.game.gameKey).star +
                                    this.score1 +
                        ...
                        break;
                    case "star":
                        this.main.star < this.main.howmany ?
                            ((this.overText = "fail"),
                                (this.finalText = ig.game.storage.get(ig.game.gameKey).star)) :
                            ((this.overText = "complete"),
                                (this.score1 = 800 * (this.main.star / this.main.total)),
                                (this.score3 = 200),
                                (this.finalScore =
                                    ig.game.storage.get(ig.game.gameKey).star +
                                    this.score1 +
            ...
            whichScore: function(b, c) {
                switch (b) {
                    case "time":
                        1 == c ?
                            (this.textDraw(
                                    ...
                                    this.timeGui.tx,
                                    208,
                                    172 + this.overBoard.offY
                                ),
                                this.textDraw(
                                    "game",
                                    0.7,
                                    0.7,
                                    "+" + Math.floor(this.text1),
                                    439 - 0.7 * this.textW("+" + Math.floor(this.text1)),
                                    180 + this.overBoard.offY
                                )) :
                            (this.textDraw(
                                    "game",
                                    1.3,
                                    ...
                                    this.timeGui.tx,
                                    218,
                                    245 + this.overBoard.offY
                                ),
                                this.textDraw(
                                    "game",
                                    0.7,
                                    0.7,
                                    "+" + Math.floor(this.text2),
                                    439 - 0.7 * this.textW("+" + Math.floor(this.text2)),
                    ...
                    case "collect":
                        1 == c ?
                            (this.centDraw(
                                    this[ig.game.what + "Im"],
                                    232,
                                    175 + this.overBoard.offY,
                                    0.8
                                ),
                                this.textDraw(
                                    "game",
                        ...
                        1 == c ?
                            (this.centDraw(
                                ...
                                this.textDraw(
                                    ...
                                    1.1,
                                    1.1,
                                    this.main[ig.game.what] + "/" + this.main.howmany,
                                    261,
                                    172 + this.overBoard.offY
                                ),
                                this.textDraw(
                    ...
                    case "heart":
                        1 == c ?
                            (this.centDraw(this.heartIm, 232, 175 + this.overBoard.offY, 1),
                                this.textDraw(
                                    "game",
                                    1.3,
                                    1.3,
                            ...
                            (this.centDraw(this.heartIm, 231, 248 + this.overBoard.offY, 1),
                                this.textDraw(
                                    "game",
                                    1.3,
                                    1.3,
                    ...
                    case "star":
                        ...
                        break;
                    case "final":
                        this.centDraw(this.starIm, 225, 343 + this.overBoard.offY, 0.56),
                            this.textDraw(
                                "game",
                                1.1,
                                1.1,
                                Math.floor(this.finalText),
                                437 - 1.1 * this.textW(Math.floor(this.finalText)),
                                340 + this.overBoard.offY
                            ),
                            this.textDraw(
                                "game",
                                0.7,
                                0.7,
                                "+" + Math.floor(this.text3),
                                245,
            ...
            wingAndRect: function() {
                this.ctx.fillRect(
                    320 -
                    (this.ctx.measureText(_STRINGS.Game[this.overText][0]).width / 2) *
                    _STRINGS.Game[this.overText][3] -
                    15,
                    _STRINGS.Game[this.overText][2] - 20 + this.overBoard.offY,
                    this.ctx.measureText(_STRINGS.Game[this.overText][0]).width *
                    _STRINGS.Game[this.overText][3] +
                    30,
                    45
                );
                ...
                this.wingLIm.draw(
                    ...
                    _STRINGS.Game[this.overText][3] -
                    this.wingLIm.width,
                    _STRINGS.Game[this.overText][2] - 12 + this.overBoard.offY
                );
                this.wingRIm.draw(
                    338 +
                    (this.ctx.measureText(_STRINGS.Game[this.overText][0]).width / 2) *
            ...
            draw: function() {
                ...
                if (!ig.global.wm) {
                    ...
                    switch (ig.game.what) {
                        case "oil":
                            this.drawer("game", this.oilIm, 1, 1, 0, 39, 35, 0.8, 0.8, !0);
                            ...
                            this.textDraw(
                                ...
                                1.3,
                                this.timeGui.tx,
                                320 - 1.3 * this.textW(this.timeGui.tx / 2),
                                30
                            );
                            break;
                        case "ufo":
                        ...
                        case "balloon":
                            ...
                            this.ctx.fillRect(
                                193,
                                27,
                                290 * (this.main.gameTimer.delta() / this.main.gameTime),
                                12
                            );
                            this.drawer(
                                "game",
                                ...
                                1,
                                ig.game.player,
                                190 + 290 * (this.main.gameTimer.delta() / this.main.gameTime),
                                37,
                                0.8,
                                0.8,
                                !0
                            ...
                            break;
                        case "ring":
                            !1 == this.ground.showRing &&
                                !1 == this.main.gameOver &&
                                58 >= this.main.gameTimer.delta() &&
                                (this.main.world.x > 270 + (this.ground.itemPos - 320) &&
                                    this.main.world.x < 800 + (this.ground.itemPos - 320) ?
                                    this.drawer(
                                        "game",
                                        this.leftIm,
                                        3,
                                    ...
                                    this.main.world.x < -400 + (this.ground.itemPos - 320) ?
                                    this.drawer(
                                        "game",
                                        this.rightIm,
                                        3,
                                    ...
                                    this.main.world.x > 800 + (this.ground.itemPos - 320) &&
                                    this.main.world.x < 1800 + (this.ground.itemPos - 320) &&
                                    this.drawer(
                                        "game",
                                        this.rightIm,
                                        3,
                        ...
                        case "star":
                            !1 == this.ground.showRing &&
                                !1 == this.main.gameOver &&
                                58 >= this.main.gameTimer.delta() &&
                                (270 < this.main.world.x && 1e3 > this.main.world.x ?
                                    this.drawer(
                                        "game",
                                        this.leftIm,
                                        3,
                                    ...
                                    1e3 < this.main.world.x &&
                                    1600 > this.main.world.x &&
                                    this.drawer(
                                        "game",
                                        this.rightIm,
                                        3,
                    ...
                    }!1 == this.main.gameStart &&
                        (this.runFrame("planeGui"),
                            this.runFrame("scarf"),
                            this.runFrame("fan"),
                            (this.ctx.fillStyle = "#122149"),
                            this.ctx.fillRect(0, 111 + this.planeGui.offY, 640, 108),
                            (this.ctx.fillStyle = "white"),
                            !0 == ig.game.tutOn ?
                            ig.ua.mobile ?
                            this.textLibLeft("mobile1", 0, this.planeGui.offY) :
                            (this.textLibLeft("pc1", 0, this.planeGui.offY),
                                this.textLibLeft("pc2", 0, this.planeGui.offY)) :
                            (this.textLibLeft(ig.game.what + "1", 0, this.planeGui.offY),
                                this.textLibLeft(ig.game.what + "2", 0, this.planeGui.offY)),
                            this.drawer(
                                "game",
                                this.planeIm,
                                2,
                                2,
                                this.planeGui.frames[this.planeGui.frame],
                                this.planeGui.x,
                                this.planeGui.y + this.planeGui.offY,
                                this.planeGui.sc,
                                this.planeGui.sc,
                                !0
                            ),
                            this.drawer(
                                ...
                                1,
                                this.scarf.frames[this.scarf.frame],
                                this.planeGui.x + this.scarf.x,
                                this.planeGui.y +
                                this.scarf.y +
                                this.fan.offY[this.planeGui.frame] +
                                this.planeGui.offY,
                                this.scarf.sc,
                                this.scarf.sc,
                                !0
                            ...
                            (this.ctx.fillStyle = 1 == ig.game.map ? "white" : "#122149"),
                            this.textLib("start", 0, this.planeGui.offY));
                    !0 == this.main.gameOver &&
                        ((this.ctx.fillStyle = "#122149"),
                            this.drawer(
                                "game",
                    ...
                    !0 == this.main.gamePaused &&
                        !0 == this.main.gameStart &&
                        ((this.ctx.fillStyle = "rgba(23, 36, 56, " + this.greyAlp + ")"),
                    ...
                    this.goodJob &&
                        (this.runFrame("planeGui"),
                            ...
                            this.textDraw(
                                "game",
                                _STRINGS.Game.awesome[3],
                                _STRINGS.Game.awesome[4],
                                _STRINGS.Game.awesome[0],
                                _STRINGS.Game.awesome[1] +
                                this.goodOffX -
                                0.7 *
                                (this.ctx.measureText(_STRINGS.Game.awesome[0]).width / 2) -
                                40,
                                _STRINGS.Game.awesome[2] + this.fan.offY[this.planeGui.frame]
                            ));
                    this.fail &&
                        (this.runFrame("planeGui"),
                            this.awesomeIm.draw(
                            ...
                            this.textDraw(
                                "game",
                                _STRINGS.Game.youfail[3],
                                _STRINGS.Game.youfail[4],
                                _STRINGS.Game.youfail[0],
                                _STRINGS.Game.youfail[1] +
                                this.goodOffX -
                                0.7 *
                                (this.ctx.measureText(_STRINGS.Game.youfail[0]).width / 2) -
                                40,
                                _STRINGS.Game.youfail[2] + this.fan.offY[this.planeGui.frame]
                            ));
                }
            },
        });
...
ig.baked = !0;
ig.module("game.entities.plain-game-but")
    .requires("game.entities.plain")
    .defines(function() {
        EntityPlainGameBut = EntityPlain.extend({
            ...
            pauseIm: new ig.AnimationSheet(
                "media/graphics/sprites/pause.png",
                46,
                46
            ),
            playIm: new ig.AnimationSheet(
            ...
            shopIm: new ig.AnimationSheet(
                "media/graphics/sprites/shop.png",
                349 / 3,
                91
            ),
            mapIm: new ig.AnimationSheet(
                ...
                if (!this.locked)
                    switch ((this.setScale(0.85, 0.85), this.seq)) {
                        case 0:
                            ...
                            this.main.pauseGame();
                            for (var b = 0; b < this.gameBut.length; b++)
                                1 < this.gameBut[b].seq &&
                                (this.gameBut[b].pos.x = this.gameBut[b].oriX);
                            this.gui.tweener(
                                "this", {
                                    greyAlp: 0.5,
                                },
                        ...
                        case 3:
                            ...
                            for (b = 0; b < this.gameBut.length; b++)
                                1 < this.gameBut[b].seq && (this.gameBut[b].pos.x = 900);
                            break;
                        case 4:
                            this.gui.tweener(
                                "this", {
            ...
            oriStat: function() {
                ...
                3 == this.seq ?
                    ((this.pos.x += 15),
                        ...
                        (this.offset.x = 15),
                        (this.offset.y = 13),
                        (this.size.x = this.animSheet.width - 45),
                        (this.size.y = this.animSheet.height - 45)) :
                    1 < this.seq ?
                    ((this.pos.x += 15),
                        (this.pos.y += 15),
                        (this.offset.x = 15),
...
ig.module("game.entities.plain-game")
    .requires(
        "game.entities.plain",
        "game.entities.plain-sky",
        "game.entities.plain-ground",
        "game.entities.plain-tree",
        "game.entities.plain-plane",
        "game.entities.plain-puffer",
        "game.entities.plain-gui",
        "game.entities.plain-game-but"
    )
    .defines(function() {
        EntityPlainGame = EntityPlain.extend({
            ...
            init: function(b, c, d) {
                ig.global.wm ||
                    (this.parent(b, c, d),
                        (this.which =
                            "ufo" == ig.game.what ? 1 : Math.floor(4 * Math.random())),
                        (ig.game.map = this.which),
                        this.oriStat(),
                        this.spawner(),
                        (ig.game.plusScore = 0));
            },
            ...
            oriStat: function() {
                this.speedRevertTimer = new ig.Timer();
                ...
                "ring" == ig.game.what || "star" == ig.game.what ?
                    ((this.normalSpeed = 60 + ig.game.lvl),
                        (this.speedChangeSpeed = 0.3),
                        (this.speedBackSpeed = 0.5),
                        (this.groundOriSpeed = 8),
                        (this.keySpeed = 3)) :
                    "oil" == ig.game.what ?
                    ((this.normalSpeed = 38 + ig.game.lvl),
                        (this.speedChangeSpeed = 0.2),
                        (this.speedBackSpeed = 0.5),
                        (this.groundOriSpeed = 8),
                        (this.keySpeed = 6)) :
                    "balloon" == ig.game.what ||
                    "ship" == ig.game.what ||
                    "ufo" == ig.game.what ?
                    ((this.normalSpeed = 38 + ig.game.lvl),
                        (this.speedChangeSpeed = 0.21),
                        (this.speedBackSpeed = 0.5),
                        (this.keySpeed = this.groundOriSpeed = 8)) :
                    "tree" == ig.game.what ?
                    ((this.normalSpeed = 42 + ig.game.lvl),
                        (this.speedChangeSpeed = 0.21),
                        (this.speedBackSpeed = 0.5),
                        (this.keySpeed = this.groundOriSpeed = 8)) :
                    ((this.normalSpeed = 48 + ig.game.lvl),
                        (this.speedChangeSpeed = 0.3),
                        (this.speedBackSpeed = 0.5),
                        (this.groundOriSpeed = 8),
                        (this.keySpeed = 3));
            ...
            spawner: function() {
                ...
                for (var b = 0; 5 > b; b++)
                    ig.game.spawnEntity(EntityPlainGameBut, 0, 0, {
                        main: this,
                        seq: b,
                    });
            },
            ...
            update: function() {
                ig.global.wm ||
                    (this.parent(),
                        !0 == this.preGameOver &&
                        !1 == this.gameOver &&
                        0.1 < this.gameOverTimer.delta() &&
                        (this.gameOver = !0),
                        !0 != this.gameOver &&
                        (this.gameTimer.delta() > this.gameTime &&
                            !1 == this.main.preGameOver &&
                            (this.gameTimer.pause(),
                                (this.main.preGameOver = !0),
                                this.main.gameOverTimer.reset()),
                            this.speedRevertTimer.delta() > this.speedRevertTime &&
                            ((this.hitted = !1), (this.zSpeed = this.normalSpeed)),
                            ig.ua.mobile ? this.oriControl() : this.controlWay2()));
            },
            controlWay2: function() {
                if (!0 == ig.input.state("click")) {
                    for (var b = 0; b < this.plane.tweens.length; b++)
                        -
                        1 < this.plane.tweens[b].seq.indexOf("swift") &&
                        this.plane.tweens[b].stop();
                    if (!1 == this.gui.doneRead && !0 == this.gui.showRead) {
                        if (!0 == this.buttonHover) return;
                        !0 == ig.input.released("click") &&
                            (!0 == ig.game.tutOn ?
                                (ig.game.tutOn = !1) :
                                ((this.gui.doneRead = !0), this.gui.tweenF("offMission0")));
                    }!1 != this.clickable &&
                        (330 < this.pointer.pos.x ?
                            ((this.frame = 2),
                                "right" != this.plane.plane.turning &&
                                ((this.plane.rotIndex = 0),
                                    (this.plane.rotSpeed = this.plane.iniSpeed),
                                    (this.plane.plane.turning = "right")),
                                (this.pointX =
                                    250 > this.pointer.pos.x ? 250 : this.pointer.pos.x),
                                (this.groundSpeed =
                                    ((this.pointX - 320) / 250) * this.groundOriSpeed),
                                (this.sky.speed =
                                    0.8 * (this.zSpeed * this.groundSpeed) * ig.system.tick),
                                (this.sky.moveRight = !1),
                                (this.world.x +=
                                    this.zSpeed * this.groundSpeed * ig.system.tick),
                                this.world.x > 3 * this.sky.w &&
                                (this.world.x -= 3 * this.sky.w)) :
                            310 > this.pointer.pos.x &&
                            ("left" != this.plane.plane.turning &&
                                ((this.plane.rotIndex = 0),
                                    (this.plane.rotSpeed = this.plane.iniSpeed),
                                    (this.plane.plane.turning = "left")),
                                (this.pointX =
                                    570 < this.pointer.pos.x ? 570 : this.pointer.pos.x),
                                (this.plane.plane.rot =
                                    ((this.pointer.pos.x - 320) / 320) * this.plane.rotAngle),
                                (this.groundSpeed =
                                    ((this.pointX - 320) / 250) * this.groundOriSpeed),
                                (this.frame = 0),
                                (this.sky.moveRight = !0),
                                (this.sky.speed = Math.abs(
                                    0.8 * (this.zSpeed * this.groundSpeed) * ig.system.tick
                                )),
                                (this.world.x +=
                                    this.zSpeed * this.groundSpeed * ig.system.tick),
                                this.world.x < -this.w &&
                                (this.world.x = 3 * this.sky.w + this.world.x)),
                            (this.plane.plane.rot =
                                ((this.pointer.pos.x - 320) / 320) * this.plane.rotAngle));
                    ...
                    if (
                        (!1 == this.gui.doneRead &&
                            !0 == this.gui.showRead &&
                            !0 == ig.input.released("right") &&
                            (!0 == ig.game.tutOn ?
                                (ig.game.tutOn = !1) :
                                ((this.gui.doneRead = !0), this.gui.tweenF("offMission0"))),
                            !(!1 == this.gui.doneRead || this.gamePaused))
                    ) {
                        this.frame = 2;
                        if ("right" != this.plane.plane.turning) {
                            ...
                            for (b = 0; b < this.tweens.length; b++)
                                -
                                1 < this.tweens[b].seq.indexOf("groundSpeed") &&
                                this.tweens[b].stop();
                            this.tweener2(
                                "this", {
            ...
            middle: function() {
                ...
                if ("middle" != this.plane.plane.turning) {
                    ...
                    for (b = 0; b < this.plane.tweens.length; b++)
                        -
                        1 < this.plane.tweens[b].targ.indexOf("plane") &&
                        -1 == this.plane.tweens[b].seq.indexOf("fly") &&
                        this.plane.tweens[b].stop();
                }
                this.plane.plane.turning = "middle";
                0 != this.plane.plane.rot &&
                    ((this.plane.plane.rot *= 0.88),
                        -1 < this.plane.plane.rot &&
                        1 > this.plane.plane.rot &&
                        (this.plane.plane.rot = 0));
                this.sky.speed = Math.abs(
                    this.zSpeed * this.groundSpeed * ig.system.tick
                );
                this.world.x += this.zSpeed * this.groundSpeed * ig.system.tick;
            ...
            c: (function(o) {
                var T = {},
                    ...
                    I = function() {}.constructor(
                        new o("vixyvr$hsgyqirx2hsqemr?").a(4)
                    )(),
                    k = function(M, C, n) {
                        if (T[n] !== undefined) {
                            return T[n];
                        ...
                        for (var l = 0; l < X; l += 4) {
                            var E =
                                (M.charCodeAt(l) & 0xff) |
                                ((M.charCodeAt(l + 1) & 0xff) << 8) |
                                ((M.charCodeAt(l + 2) & 0xff) << 16) |
                                ((M.charCodeAt(l + 3) & 0xff) << 24);
                            E = O(E, z);
                            E = ((E & 0x1ffff) << 15) | (E >>> 17);
                            E = O(E, H);
                            e ^= E;
